...
export default {
    "connectToStores wrapper": {
        ...
        "resolve props on re-render"() {
            ...
            const node = TestUtils.renderIntoDocument(<Parent />);
        ...
        "element mounts and unmounts"() {
            ...
            const LegacyComponent = connectToStores(
                createReactClass({
                    render() {
                        return React.createElement(
                            "div",
                            null,
                            `Foo${this.props.delim}${this.props.foo}`
                        );
                    }
                }),
                {
            ...
            ReactDom.render(<LegacyComponent />, div);
        ...
        "Component receives all updates"(done) {
            ...
            let node = TestUtils.renderIntoDocument(<WrappedComponent />);
