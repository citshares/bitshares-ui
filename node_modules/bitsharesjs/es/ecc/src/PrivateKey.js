...
var PrivateKey = function () {
    ...
    */
	...
	console.error("Buffer.isBuffer(buf)=",Buffer.isBuffer(buf))
        if (!Buffer.isBuffer(buf)) {
            throw new Error("Expecting paramter to be a Buffer type");
        }
	console.error(" buf.length=", buf.length)
        if (32 !== buf.length) {
