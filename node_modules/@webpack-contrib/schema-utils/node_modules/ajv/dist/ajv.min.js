                ...
                function(e, r, t) {
                    ...
                    r.exports = function c(e, u, h, r) {
                        ...
                        function w(e, r, t, a) {
                            ...
                            if (r.schema != u.schema)
                                return c.call(d, e, r, t, a);
                            var o,
                                i = !0 === e.$async,
                                n = O({
                                    isTop: !0,
                        ...
                        function S(e, r, t) {
                            ...
                            var a,
                                ...
                                o = m[r];
                            if (void 0 !== o)
                                return _((a = p[o]), (s = "refVal[" + o + "]"));
                            if (!t && u.refs) {
                                var i = u.refs[r];
                                if (void 0 !== i)
                                    return (
                                        (s = b(r, (a = u.refVal[i]))), _(a, s)
                                    );
                            }
                            s = b(r);
                            var n = $.call(d, w, u, r);
                            ...
                            if (s && !1 !== d._opts.validateSchema) {
                                ...
                                if (!o) {
                                    var i =
                                        ...
                                        d.errorsText(s.errors);
                                    if ("log" != d._opts.validateSchema)
                                        throw new Error(i);
                                    d.logger.error(i);
                                }
                            }
                ...
                function(e, r, t) {
                    ...
                    function c(e, r, t) {
                        ...
                        return (
                            ...
                            s instanceof l
                                ? (o =
                                      s.validate ||
                                      e.call(this, s.schema, r, void 0, i))
                                : void 0 !== s &&
                    ...
                    function u(e, r) {
                        ...
                        if (0 === Object.keys(e.schema).length || a !== s) {
                            ...
                            if (i instanceof l)
                                i.validate || this._compile(i), (e = i);
                            else {
                                if (!((i = this._schemas[o]) instanceof l))
                                    return;
                        ...
                        if (
                            ...
                            for (
                                ...
                                if (i) {
                                    if (
                                        void 0 ===
                                        (t = t[(i = g.unescapeFragment(i))])
                                    )
                                        break;
                                    var n;
                                    if (
                                        !h[i] &&
                                        ((n = this._getId(t)) && (r = p(r, n)),
                                        t.$ref)
                                    ) {
                                        var l = p(r, t.$ref),
                                            c = u.call(this, a, l);
                ...
                function(e, r, t) {
                    ...
                    r.exports = function(e, r, t) {
                        ...
                        if (m && b.$data) {
                            ...
                            if (!(P = e.useCustomRule(w, l, e.schema, e)))
                                return;
                            (s = "validate.schema" + c),
                                (E = P.code),
                                (v = b.compile),
                        ...
                        for (var w in ((a += "var missing" + s + ";"), v))
                            if ((P = v[w]).length) {
                                if (
                                    ...
                                    if (D)
                                        for (
                                            var j, O = -1, I = D.length - 1;
                                            O < I;

                                        ) {
                                            j = D[(O += 1)];
                                            var A = e.util.getProperty(j),
                                                C = ((x = e.util.escapeQuotes(
                                                    j
                                                )),
                                                u + A);
                                            e.opts._errorDataPathProperty &&
                    ...
                    r.exports = function(e, r, t) {
                        ...
                        if (d || p.length) {
                            ...
                            if (c)
                                ...
                                if (j)
                                    for (
                                        var O, I = -1, A = j.length - 1;
                                        I < A;

                                    ) {
                                        O = j[(I += 1)];
                                        var C = e.util.getProperty(O),
                                            k = ((b = e.util.escapeQuotes(O)),
                                            u + C);
                                        e.opts._errorDataPathProperty &&
                                            (e.errorPath = e.util.getPath(
                                                E,
                    ...
                    r.exports = function(a, e, r) {
                        ...
                        if (a.isTop) {
                            ...
                            (n = a.level = 0),
                                (l = a.dataLevel = 0),
                                (f = "data");
                            (a.rootId = a.resolve.fullPath(
                                a.self._getId(a.root.schema)
                            )),
                            ...
                            (n = a.level),
                                (f = "data" + ((l = a.dataLevel) || ""));
                            if (
                                (i && (a.baseId = a.resolve.url(a.baseId, i)),
                                s && !a.async)
                            )
                        ...
                        if (
                            (a.schema.$comment &&
                                ...
                                (t +=
                                    " " +
                                    a.RULES.all.$comment.code(a, "$comment")),
                            P)
                        ) {
                            if (a.opts.coerceTypes)
                                var w = a.util.coerceToTypes(
                                    a.opts.coerceTypes,
                                    P
                                );
                    ...
                    (a = this),
                        (function(e) {
                            ...
                            function j(r) {
                                ...
                                return (
                                    void 0 !== r.query &&
                                        (a.push("?"), a.push(r.query)),
                                    void 0 !== r.fragment &&
                                        (a.push("#"), a.push(r.fragment)),
                                    a.join("")
                                );
                            }
                            function O(e, r) {
            ...
            ajv: [
                function(a, e, r) {
                    ...
                    function g(e) {
                        ...
                        var r = (this._schemaUriFormat = this._formats[
                            "uri-reference"
                        ]);
