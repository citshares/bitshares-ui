    ...
    switch (starttype) {
        ...
        case tokTypes._continue:
            ...
            if (this.semicolon() || this.canInsertSemicolon()) {
                ...
                node.label =
                    this.tok.type === tokTypes.name ? this.parseIdent() : null;
                this.semicolon();
            }
        ...
        case tokTypes._try:
            ...
            node.finalizer = this.eat(tokTypes._finally)
                ? this.parseBlock()
                : null;
    ...
    do {
        ...
        decl.id =
            this$1.options.ecmaVersion >= 6
                ...
                : this$1.parseIdent();
        decl.init = this$1.eat(tokTypes.eq)
...
lp$1.parseClass = function(isStatement) {
    ...
    while (!this.closes(tokTypes.braceR, indent, line)) {
        ...
        if (
            ...
            isAsync = true;
            isGenerator =
                this$1.options.ecmaVersion >= 9 && this$1.eat(tokTypes.star);
            this$1.parsePropertyName(method);
        } else {
            isAsync = false;
        }
...
lp$2.parseExprAtom = function() {
    ...
    switch (this.tok.type) {
        ...
        case tokTypes._super:
            var type =
                this.tok.type === tokTypes._this ? "ThisExpression" : "Super";
            node = this.startNode();
            this.next();
            return this.finishNode(node, type);
