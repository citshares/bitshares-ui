(function(global, factory) {
    ...
    LooseParser.prototype.canInsertSemicolon = function canInsertSemicolon() {
        return (
            ...
            acorn.lineBreak.test(
                this.input.slice(this.last.end, this.tok.start)
            )
        );
    };
    ...
    lp.resetTo = function(pos) {
        ...
        if (this.options.locations) {
            ...
            var match;
            while (
                (match = acorn.lineBreakG.exec(this.input)) &&
                match.index < pos
            ) {
                ++this$1.toks.curLine;
        ...
        switch (starttype) {
            ...
            case acorn.tokTypes._for:
                ...
                if (
                    ...
                    var init$1 = this.parseVar(
                        true,
                        isLet ? "let" : this.tok.value
                    );
                    if (
            ...
            case acorn.tokTypes._switch:
                ...
                var cur;
                while (
                    !this.closes(acorn.tokTypes.braceR, blockIndent, line, true)
                ) {
                    if (
            ...
            case acorn.tokTypes._try:
                ...
                if (this.tok.type === acorn.tokTypes._catch) {
                    ...
                    this.next();
                    this.expect(acorn.tokTypes.parenL);
                    clause.param = this.toAssignable(
                        this.parseExprAtom(),
                        true
                    );
    ...
    lp$1.parseFor = function(node, init) {
        ...
        if (
            ...
            this.tok.type !== acorn.tokTypes.semi
        )
    ...
    lp$1.parseVar = function(noIn, kind) {
        ...
        if (!node.declarations.length) {
            ...
            node.declarations.push(
                this.finishNode(decl$1, "VariableDeclarator")
            );
        }
    ...
    lp$2.parseMaybeAssign = function(noIn) {
        if (this.toks.isContextual("yield")) {
            ...
            if (
                ...
                (this.tok.type != acorn.tokTypes.star &&
                    !this.tok.type.startsExpr)
            ) {
                node.delegate = false;
                node.argument = null;
            } else {
    ...
    lp$2.parseExprAtom = function() {
        ...
        switch (this.tok.type) {
            ...
            case acorn.tokTypes._super:
                var type =
                    this.tok.type === acorn.tokTypes._this
                        ? "ThisExpression"
                        : "Super";
                node = this.startNode();
                this.next();
    ...
    lp$2.parseMethod = function(isGenerator) {
        ...
        node.expression =
            ...
            this.tok.type !== acorn.tokTypes.braceL;
