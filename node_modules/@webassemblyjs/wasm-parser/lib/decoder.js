...
function decode(ab, opts) {
    ...
    function parseImportSection(numberOfImports) {
        ...
        for (var i = 0; i < numberOfImports; i++) {
            ...
            if (descrType === "func") {
                ...
                throw new _helperApiError.CompileError(
                    "Unsupported import of type: " + descrType
                );
            }
        ...
        for (var i = 0; i < numberOfExport; i++) {
            ...
            if (exportTypes[typeIndex] === "Func") {
                ...
                if (typeof func === "undefined") {
                    throw new _helperApiError.CompileError(
                        "entry not found at index ".concat(
                            index,
                            " in function section"
                        )
                    );
        ...
        for (var i = 0; i < numberOfFuncs; i++) {
            ...
            for (var _i = 0; _i < funcLocalNum; _i++) {
                ...
                if (typeof type === "undefined") {
                    throw new _helperApiError.CompileError(
                        "Unexpected valtype: " + toHex(valtypeByte)
                    );
                }
    ...
    function parseInstructionBlock(code) {
        while (true) {
            ...
            if (typeof instruction.object === "string") {
                dump(
                    [instructionByte],
                    "".concat(instruction.object, ".").concat(instruction.name)
                );
            } else {
            ...
            if (instruction.name === "loop") {
                ...
                if (typeof _blocktype === "undefined") {
                    throw new _helperApiError.CompileError(
                        "Unexpected blocktype: " + toHex(_blocktypeByte)
                    );
                }

                var testIndex = t.withRaw(
                ...
                if (typeof _blocktype2 === "undefined") {
                    throw new _helperApiError.CompileError(
                        "Unexpected blocktype: " + toHex(_blocktypeByte2)
                    );
                }
                ...
                var _label = t.withRaw(
                    t.identifier(getUniqueName("block")),
                    ""
                );

                var blockNode = t.blockInstruction(
                    _label,
                    _instr2,
                    _blocktype2
                );
                ...
                if (typeof signature === "undefined") {
                    throw new _helperApiError.CompileError(
                        "call_indirect signature not found (".concat(
                            typeindex,
                            ")"
                        )
                    );
                ...
                for (var i = 0; i <= indices; i++) {
                    ...
                    dump([_index], "index");
                    args.push(
                        t.numberLiteralFromRaw(_indexu.value.toString(), "u32")
                    );
                }
    ...
    function parseGlobalType() {
        ...
        if (typeof type === "undefined") {
            throw new _helperApiError.CompileError(
                "Unknown valtype: " + toHex(valtypeByte)
            );
        }
        ...
        if (typeof globalType === "undefined") {
            throw new _helperApiError.CompileError(
                "Invalid mutability: " + toHex(globalTypeByte)
            );
        }
    ...
    function parseNameSection(remainingBytes) {
        ...
        while (offset - initialOffset < remainingBytes) {
            ...
            if (sectionTypeByte === 0) {
                nameMetadata.push.apply(
                    nameMetadata,
                    _toConsumableArray(parseNameModule())
                );
            } else if (sectionTypeByte === 1) {
                nameMetadata.push.apply(
                    nameMetadata,
                    _toConsumableArray(parseNameSectionFunctions())
                );
            } else if (sectionTypeByte === 2) {
                nameMetadata.push.apply(
                    nameMetadata,
                    _toConsumableArray(parseNameSectionLocals())
                );
            }
        }
    ...
    function parseStartSection() {
        ...
        var endLoc = getPosition();
        return t.withLoc(
            t.start(t.indexLiteral(startFuncIndex)),
            endLoc,
            startLoc
        );
    ...
    function parseSection(sectionIndex) {
        ...
        if (sectionId >= sectionIndex || sectionIndex === sections.custom) {
            ...
            if (sectionId !== sections.custom)
                throw new _helperApiError.CompileError(
                    "Unexpected section: " + toHex(sectionId)
                );
        }
        ...
        switch (sectionId) {
            ...
            case sections.start: {
                ...
                var _metadata7 = t.sectionMetadata(
                    "start",
                    startOffset,
                    sectionSizeInBytesNode
                );
            ...
            case sections.memory: {
                ...
                var _metadata10 = t.sectionMetadata(
                    ...
                    sectionSizeInBytesNode,
                    t.withLoc(
                        t.numberLiteralFromRaw(_numberOfElements),
                        _endPosition8,
                        _startPosition9
                    )
                );
            ...
            case sections.data: {
                ...
                var _metadata11 = t.sectionMetadata(
                    "data",
                    startOffset,
                    sectionSizeInBytesNode
                );
            ...
            case sections.custom: {
                ...
                var _remainingBytes2 =
                    sectionSizeInBytes - sectionName.nextIndex;
    ...
    while (offset < buf.length) {
        ...
        var metadataArray = Array.isArray(_metadata13)
            ? _metadata13
            : [_metadata13];
