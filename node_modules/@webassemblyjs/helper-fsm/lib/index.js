    ...
    return function(instance) {
        if (allowedSeparator) {
            if (instance.input[instance.ptr] === allowedSeparator) {
                if (
                    regex.test(
                        instance.input.substring(instance.ptr - 1, instance.ptr)
                    )
                ) {
        ...
        if (
            regex.test(instance.input.substring(instance.ptr, instance.ptr + n))
        ) {
            return [nextState, n];
        }
...
var FSM =
    ...
    (function() {
        function FSM(transitions, initialState) {
            ...
            this.transitionFunction = combineTransitions.call(
                this,
                transitions
            );
        }
        ...
        _createClass(FSM, [
            {
                ...
                value: function run(input) {
                    ...
                    while (
                        ...
                        var _transitionFunction2 = _slicedToArray(
                            _transitionFunction,
                            2
                        );
