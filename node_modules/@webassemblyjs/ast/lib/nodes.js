...
function assertTypeOf(t) {
    return function(n) {
        return (function() {
            if (!(n.type === t)) {
                throw new Error(
                    "n.type === t" + " error: " + (undefined || "unknown")
                );
            }
        })();
    };
...
function _module(id, fields, metadata) {
    if (id !== null && id !== undefined) {
        if (!(typeof id === "string")) {
            throw new Error(
                'typeof id === "string"' + " error: " + (undefined || "unknown")
            );
        }
    }

    if (
        !(_typeof(fields) === "object" && typeof fields.length !== "undefined")
    ) {
        throw new Error(
...
function moduleMetadata(sections, functionNames, localNames) {
    if (
        !(
            _typeof(sections) === "object" &&
            typeof sections.length !== "undefined"
        )
    ) {
        throw new Error(
    ...
    if (localNames !== null && localNames !== undefined) {
        if (
            !(
                _typeof(localNames) === "object" &&
                typeof localNames.length !== "undefined"
            )
        ) {
            throw new Error(
...
function moduleNameMetadata(value) {
    if (!(typeof value === "string")) {
        throw new Error(
            'typeof value === "string"' + " error: " + (undefined || "unknown")
        );
    }
...
function functionNameMetadata(value, index) {
    ...
    if (!(typeof index === "number")) {
        throw new Error(
            'typeof index === "number"' + " error: " + (undefined || "unknown")
        );
    }
...
function quoteModule(id, string) {
    ...
    if (
        !(_typeof(string) === "object" && typeof string.length !== "undefined")
    ) {
        throw new Error(
...
function ifInstruction(testLabel, test, result, consequent, alternate) {
    ...
    if (
        !(
            _typeof(consequent) === "object" &&
            typeof consequent.length !== "undefined"
        )
    ) {
        throw new Error(
    ...
    if (
        !(
            _typeof(alternate) === "object" &&
            typeof alternate.length !== "undefined"
        )
    ) {
        throw new Error(
...
function numberLiteral(value, raw) {
    if (!(typeof value === "number")) {
        throw new Error(
            'typeof value === "number"' + " error: " + (undefined || "unknown")
        );
    }

    if (!(typeof raw === "string")) {
        throw new Error(
            'typeof raw === "string"' + " error: " + (undefined || "unknown")
        );
    }
...
function elem(table, offset, funcs) {
    if (
        !(_typeof(offset) === "object" && typeof offset.length !== "undefined")
    ) {
        throw new Error(
...
function moduleImport(module, name, descr) {
    if (!(typeof module === "string")) {
        throw new Error(
            'typeof module === "string"' + " error: " + (undefined || "unknown")
        );
    }

    if (!(typeof name === "string")) {
        throw new Error(
            'typeof name === "string"' + " error: " + (undefined || "unknown")
        );
    }
...
function limit(min, max) {
    if (!(typeof min === "number")) {
        throw new Error(
            'typeof min === "number"' + " error: " + (undefined || "unknown")
        );
    }
...
function signature(params, results) {
    if (
        !(_typeof(params) === "object" && typeof params.length !== "undefined")
    ) {
        throw new Error(
...
function callInstruction(index, instrArgs) {
    if (instrArgs !== null && instrArgs !== undefined) {
        if (
            !(
                _typeof(instrArgs) === "object" &&
                typeof instrArgs.length !== "undefined"
            )
        ) {
            throw new Error(
...
function callIndirectInstruction(signature, intrs) {
    if (intrs !== null && intrs !== undefined) {
        if (
            !(
                _typeof(intrs) === "object" &&
                typeof intrs.length !== "undefined"
            )
        ) {
            throw new Error(
...
function byteArray(values) {
    if (
        !(_typeof(values) === "object" && typeof values.length !== "undefined")
    ) {
        throw new Error(
