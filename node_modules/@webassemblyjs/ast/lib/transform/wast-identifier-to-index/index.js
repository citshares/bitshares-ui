...
function transform(ast) {
    ...
    var moduleContext = (0, _helperModuleContext.moduleContextFromModuleAST)(
        module
    ...
    (0, _index.traverse)(ast, {
        ...
        Start: (function(_Start) {
            ...
            if ((0, _index.isIdentifier)(index) === true) {
                var offsetInModule = moduleContext.getFunctionOffsetByIdentifier(
                    index.value
                );
                ...
                path.node.index = (0, _index.numberLiteralFromRaw)(
                    offsetInModule
                );
            }
        })
        ...
        Instr: (function(_Instr) {
            ...
            if (
                ...
                if (firstArg.type === "Identifier") {
                    ...
                    instrNode.args[0] = (0, _index.numberLiteralFromRaw)(
                        offsetInParams
                    );
                }
            }
            ...
            if (
                instrNode.id === "get_global" ||
                instrNode.id === "set_global"
            ) {
