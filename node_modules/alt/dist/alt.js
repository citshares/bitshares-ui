(function webpackUniversalModuleDefinition(root, factory) {
    ...
    else if (typeof exports === "object") exports["Alt"] = factory();
    else root["Alt"] = factory();
    ...
    return /******/ (function(modules) {
        ...
        /******/ [
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var builtInProto = Object.getOwnPropertyNames(
                    NoopClass.prototype
                );
                /*eslint-enable*/
                ...
                function getInternalMethods(Obj, isProto) {
                    ...
                    return Object.getOwnPropertyNames(obj).reduce(function(
                        value,
                        m
                    ) {
                ...
                function formatAsConstant(name) {
                    return name
                        .replace(/[a-z]([A-Z])/g, function(i) {
                            return (
                                String(i[0]) + "_" + String(i[1].toLowerCase())
                            );
                        })
                        .toUpperCase();
                }
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var Alt = (function() {
                    function Alt() {
                        ...
                        this.dispatcher =
                            config.dispatcher || new _flux.Dispatcher();
                        this.batchingFunction =
                            config.batchingFunction ||
                            function(callback) {
                                return callback();
                            };
                        this.actions = {global: {}};
                    ...
                    Alt.prototype.dispatch = (function() {
                        function dispatch(action, data, details) {
                            ...
                            this.batchingFunction(function() {
                                ...
                                return _this.dispatcher.dispatch(
                                    utils.fsa(id, action, data, details)
                                );
                            });
                        }
                    ...
                    Alt.prototype.createUnsavedStore = (function() {
                        function createUnsavedStore(StoreModel) {
                            ...
                            return fn.isFunction(Store)
                                ? store.createStoreFromClass.apply(
                                      store,
                                      [this, Store, key].concat(args)
                                  )
                    ...
                    Alt.prototype.createStore = (function() {
                        function createStore(StoreModel, iden) {
                            ...
                            if (this.stores[key] || !key) {
                                if (this.stores[key]) {
                                    utils.warn(
                                        "A store named " +
                                            String(key) +
                                            " already exists, double check your store " +
                            ...
                            var storeInstance = fn.isFunction(Store)
                                ? store.createStoreFromClass.apply(
                                      store,
                                      [this, Store, key].concat(args)
                                  )
                    ...
                    Alt.prototype.generateActions = (function() {
                        function generateActions() {
                            ...
                            return this.createActions(
                                actionNames.reduce(function(obj, action) {
                    ...
                    Alt.prototype.createActions = (function() {
                        function createActions(ActionsClass) {
                            ...
                            if (fn.isFunction(ActionsClass)) {
                                fn.assign(
                                    actions,
                                    utils.getPrototypeChain(ActionsClass)
                                );

                                var ActionsGenerator = (function(
                                    _ActionsClass
                                ) {
                                    ...
                                    ActionsGenerator.prototype.generateActions = (function() {
                                        function generateActions() {
                                            ...
                                            actionNames.forEach(function(
                                                actionName
                                            ) {
                                                actions[actionName] =
                                                    utils.dispatchIdentity;
                                            });
                                        }
                                ...
                                fn.assign(
                                    ...
                                    new (Function.prototype.bind.apply(
                                        ActionsGenerator,
                                        [null].concat(argsForConstructor)
                                    ))()
                                );
                            } else {
                            ...
                            fn.eachObject(
                                function(actionName, action) {
                                    ...
                                    // generate a constant
                                    var constant = utils.formatAsConstant(
                                        actionName
                                    );
                                    exportObj[constant] =
                    ...
                    Alt.prototype.takeSnapshot = (function() {
                        function takeSnapshot() {
                            ...
                            var state = StateFunctions.snapshot(
                                this,
                                storeNames
                            );
                    ...
                    Alt.prototype.recycle = (function() {
                        function recycle() {
                            ...
                            var initialSnapshot = storeNames.length
                    ...
                    Alt.prototype.bootstrap = (function() {
                        function bootstrap(data) {
                            StateFunctions.setAppState(this, data, function(
                                storeInst,
                                state
                            ) {
                    ...
                    Alt.prototype.addActions = (function() {
                        function addActions(name, ActionsClass) {
                            ...
                            this.actions[name] = Array.isArray(ActionsClass)
                                ...
                                : this.createActions.apply(
                                      this,
                                      [ActionsClass].concat(args)
                                  );
                        }
                    ...
                    Alt.prototype.addStore = (function() {
                        function addStore(name, StoreModel) {
                            ...
                            this.createStore.apply(
                                this,
                                [StoreModel, name].concat(args)
                            );
                        }
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function(process) {
                    ...
                    var Dispatcher = (function() {
                        ...
                        Dispatcher.prototype.register = function register(
                            callback
                        ) {
                        ...
                        Dispatcher.prototype.unregister = function unregister(
                            id
                        ) {
                            !this._callbacks[id]
                        ...
                        Dispatcher.prototype._invokeCallback = function _invokeCallback(
                            id
                        ) {
                        ...
                        Dispatcher.prototype._startDispatching = function _startDispatching(
                            payload
                        ) {
                            for (var id in this._callbacks) {
            ...
            /***/ function(module, exports, __webpack_require__) {
                        ...
                        function(key, value) {
                            ...
                            if (store) {
                                ...
                                if (config.onDeserialize)
                                    obj[key] =
                                        config.onDeserialize(value) || value;
                ...
                function snapshot(instance) {
                    ...
                    var stores = storeNames.length
                        ? storeNames
                        : Object.keys(instance.stores);
                ...
                function saveInitialSnapshot(instance, key) {
                    var state = instance.deserialize(
                ...
                function filterSnapshots(instance, state, stores) {
                    return stores.reduce(function(obj, store) {
                        ...
                        if (!state[storeName]) {
                            throw new ReferenceError(
                                String(storeName) + " is not a valid store"
                            );
                        }
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                function doSetState(store, storeInstance, state) {
                    ...
                    var nextState = fn.isFunction(state)
                ...
                function createStoreFromObject(alt, StoreModel, key) {
                    ...
                    var StoreProto = createPrototype(
                        {},
                        alt,
                        key,
                        fn.assign(
                    ...
                    if (StoreProto.bindListeners) {
                        _StoreMixin2["default"].bindListeners.call(
                            StoreProto,
                    ...
                    storeInstance = fn.assign(
                        new _AltStore2["default"](
                            alt,
                            StoreProto,
                            StoreProto.state !== undefined
                                ? StoreProto.state
                                : {},
                            StoreModel
                        ),
                ...
                function createStoreFromClass(alt, StoreModel, key) {
                    ...
                    var store = new (Function.prototype.bind.apply(
                        Store,
                        [null].concat(argsForClass)
                    ))();
                ...
                var AltStore = (function() {
                    function AltStore(alt, model, state, StoreModel) {
                        ...
                        this.lifecycle = function(event, x) {
                            if (lifecycleEvents[event])
                                lifecycleEvents[event].publish(x);
                        };
                        this.state = state;
                        ...
                        this.emitChange = function() {
                            return _this.transmitter.publish(
                                output(_this.state)
                            );
                        };

                        var handleDispatch = function handleDispatch(
                            f,
                            payload
                        ) {
                            try {
                        ...
                        // Register dispatcher
                        this.dispatchToken = alt.dispatcher.register(function(
                            payload
                        ) {
                            ...
                            var actionHandlers =
                                model.actionListeners[payload.action];
                    ...
                    AltStore.prototype.listen = (function() {
                        function listen(cb) {
                            ...
                            if (!fn.isFunction(cb))
                                throw new TypeError(
                                    "listen expects a function"
                                );

                            var _transmitter$subscrib = this.transmitter.subscribe(
                                    cb
                                ),
                ...
                var StoreMixin = {
                    waitFor: (function() {
                        function waitFor() {
                            ...
                            if (!sources.length) {
                                throw new ReferenceError(
                                    "Dispatch tokens not provided"
                                );
                            }

                            var sourcesArray = sources;
                            if (sources.length === 1) {
                                sourcesArray = Array.isArray(sources[0])
                                    ? sources[0]
                                    : sources;
                            }
                    ...
                    registerAsync: (function() {
                        function registerAsync(asyncDef) {
                            ...
                            var asyncMethods = fn.isFunction(asyncDef)
                                ? asyncDef(this.alt)
                                : asyncDef;

                            var toExport = Object.keys(asyncMethods).reduce(
                                function(publicMethods, methodName) {
                                    var desc = asyncMethods[methodName];
                                    var spec = fn.isFunction(desc)
                                        ? desc(_this)
                                        : desc;
                                    ...
                                    validHandlers.forEach(function(handler) {
                                        if (
                                            ...
                                            throw new Error(
                                                String(handler) +
                                                    " handler must be an action function"
                                            );
                                        }
                                    });
                                    ...
                                    publicMethods[methodName] = function() {
                                        ...
                                        var shouldFetch = spec.shouldFetch
                                            ? spec.shouldFetch.apply(
                                                  spec,
                                                  [state].concat(args)
                                              )
                                            : /*eslint-disable*/
                            ...
                            fn.eachObject(
                                function(methodName, value) {
                                    if (!fn.isFunction(value)) {
                                        throw new TypeError(
                                            "exportPublicMethods expects a function"
                                        );
                                    }
                    ...
                    on: (function() {
                        function on(lifecycleEvent, handler) {
                            ...
                            var bus =
                                this.lifecycleEvents[lifecycleEvent] ||
                                (0, _transmitter2["default"])();
                    ...
                    bindAction: (function() {
                        function bindAction(symbol, handler) {
                            ...
                            if (!fn.isFunction(handler)) {
                                throw new TypeError(
                                    "bindAction expects a function"
                                );
                            }

                            // You can pass in the constant or the function itself
                            var key = symbol.id ? symbol.id : symbol;
                            this.actionListeners[key] =
                                this.actionListeners[key] || [];
                            ...
                            fn.eachObject(
                                function(methodName, symbol) {
                                    ...
                                    if (!listener) {
                                        throw new ReferenceError(
                                            String(methodName) +
                                                " defined but does not exist in " +
                                                String(_this4.displayName)
                                        );
                                    }
                ...
                function makeAction(alt, namespace, name, implementation, obj) {
                    ...
                    var action = function action() {
                        ...
                        if (
                            ...
                            !(0, _isPromise2["default"])(invocationResult)
                        ) {
