...
class AbstractStoreModel<S> implements AltJS.StoreModel<S> {
    ...
    exportPublicMethods: (
        config: {[key: string]: (...args: Array<any>) => any}
    ) => any;
...
var generatedActions = alt.createActions<TestActionsGenerate>(
    GenerateActionsClass
);
var explicitActions = alt.createActions<ExplicitActionsClass>(
    ExplicitActionsClass
);
...
class TestStore extends AbstractStoreModel<AltTestState>
