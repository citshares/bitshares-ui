...
})(
    {
        1: [
            function(e, t, n) {
                t.exports = function(t) {
                    switch (parseInt(t.version)) {
                        case 2:
                        case 3:
                            t.plugins.asyncawait = e("./acorn-v3");
                            break;
                        case 4:
                        case 5:
                            t.plugins.asyncawait = e("./acorn-v4");
                            break;
                        default:
                            throw new Error(
                                "acorn-es7-plugin requires Acorn v2, 3, 4 or 5"
                            );
                    }
                    return t;
                };
            },
            {"./acorn-v3": 2, "./acorn-v4": 3}
        ],
        2: [
            function(e, t, n) {
                function r(e, t) {
                    return e.lineStart >= t;
                }
                function i(e, t, n) {
                    var r = t.input.slice(t.start);
                    return n && (r = r.replace(l, "$1 $3")), e.test(r);
                }
                function s(e, t, n, r) {
                    ...
                    return (
                        ...
                        r && (i.options.preserveParens = !0),
                        i.nextToken(),
                        i
                    );
                }
                var o = {},
                    a = /^async[\t ]+(return|throw)/,
                    u = /^async[\t ]+function/,
                    c = /^\s*[():;]/,
                    l = /([^\n])\/\*(\*(?!\/)|[^\n*])*\*\/([^\n])/g,
                    p = /\s*(get|set)\s*\(/;
                t.exports = function(e, t) {
                    var n = function() {};
                    e.extend("initialContext", function(r) {
                        return function() {
                            return (
                                this.options.ecmaVersion < 7 &&
                                    (n = function(t) {
                                        e.raise(
                                            t.start,
                                            "async/await keywords only available when ecmaVersion>=7"
                                        );
                                    }),
                                (this.reservedWords = new RegExp(
                                    this.reservedWords
                                        .toString()
                                        .replace(/await|async/g, "")
                                        .replace("|/", "/")
                                        .replace("/|", "/")
                                        .replace("||", "|")
                                )),
                                (this.reservedWordsStrict = new RegExp(
                                ...
                                (this.reservedWordsStrictBind = new RegExp(
                                ...
                                (this.inAsyncFunction = t.inAsyncFunction),
                                t.awaitAnywhere &&
                                    t.inAsyncFunction &&
                                    e.raise(
                                        node.start,
                                        "The options awaitAnywhere and inAsyncFunction are mutually exclusive"
                                    ),
                                r.apply(this, arguments)
                            );
                        };
                    }),
                        e.extend("shouldParseExportStatement", function(e) {
                            return function() {
                                return (
                                    !(
                        ...
                        e.extend("parseStatement", function(e) {
                            return function(n, r) {
                                var s = this.start,
                                    o = this.startLoc;
                                if ("name" === this.type.label)
                                    if (i(u, this, !0)) {
                                        var c = this.inAsyncFunction;
                                        try {
                                            return (
                                                (this.inAsyncFunction = !0),
                                                this.next(),
                        ...
                        e.extend("parseIdent", function(e) {
                            return function(t) {
                                ...
                                return (
                                    this.inAsyncFunction &&
                                        ...
                                        this.raise(
                                            n.start,
                                            "'await' is reserved within async functions"
                                        ),
                                    n
                                );
                            };
                                ...
                                if ("Identifier" === p.type)
                                    if ("async" !== p.name || r(this, p.end)) {
                                        if ("await" === p.name) {
                                            ...
                                            if (
                                                this.input.slice(p.end).match(c)
                                            )
                                                return t.awaitAnywhere ||
                                                    "module" !==
                                                        this.options.sourceType
                                                    ? p
                                                    : this.raise(
                                                          p.start,
                                                          "'await' is reserved within modules"
                                                      );
                                            if (
                                                "object" == typeof t &&
                                                t.awaitAnywhere &&
                                        ...
                                        try {
                                            ...
                                            this.inAsyncFunction = f;
                                        }
                                    }
                                return p;
                            };
                        }),
                        e.extend("finishNodeAt", function(e) {
                            return function(t, n, r, i) {
                                return (
                                    t.__asyncValue &&
                                        (delete t.__asyncValue,
                                        (t.value.async = !0)),
                                    e.apply(this, arguments)
                                );
                            };
                        }),
                        e.extend("finishNode", function(e) {
                            return function(t, n) {
                                return (
                                    t.__asyncValue &&
                                        (delete t.__asyncValue,
                            ...
                            return function(t) {
                                ...
                                return (
                                    "Identifier" !== i.type ||
                                        "async" !== i.name ||
                                        r(this, i.end) ||
                                        this.input.slice(i.end).match(c) ||
                                        (p.test(this.input.slice(i.end))
                                            ...
                                            : (n(t),
                                              "set" === t.kind &&
                                                  this.raise(
                                                      i.start,
                                                      "'set <member>(value)' cannot be be async"
                                                  ),
                                              "Identifier" ===
                                                  (i = e.apply(this, arguments))
                                                      .type &&
                            ...
                            return function(t, n, r) {
                                ...
                                n.__asyncValue &&
                                    ("constructor" === n.kind &&
                                        this.raise(
                                            n.start,
                                            "class constructor() cannot be be async"
                                        ),
                                    (i = this.inAsyncFunction),
                                    (this.inAsyncFunction = !0));
                                var s = e.apply(this, arguments);
                                return (this.inAsyncFunction = i), s;
                            };
                        }),
                        e.extend("parseMethod", function(e) {
                            return function(t) {
                                var n;
                                this.__currentProperty &&
                                    this.__currentProperty.__asyncValue &&
                                    ((n = this.inAsyncFunction),
                                    (this.inAsyncFunction = !0));
                                var r = e.apply(this, arguments);
                                return (this.inAsyncFunction = n), r;
                            };
                        }),
                        e.extend("parsePropertyValue", function(e) {
                            return function(t, n, r, i, s, o) {
                                var a = this.__currentProperty;
                                this.__currentProperty = t;
                                var u;
                                t.__asyncValue &&
                                    ((u = this.inAsyncFunction),
                                    (this.inAsyncFunction = !0));
                                var c = e.apply(this, arguments);
                                return (
                                    (this.inAsyncFunction = u),
                                    (this.__currentProperty = a),
                                    c
                                );
                            };
                        });
        ...
        3: [
            function(e, t, n) {
                ...
                var i = /^async[\t ]+(return|throw)/,
                    s = /^\s*[):;]/,
                    o = /([^\n])\/\*(\*(?!\/)|[^\n*])*\*\/([^\n])/g;
                t.exports = function(e, t) {
                    (t && "object" == typeof t) || (t = {}),
                        e.extend("parse", function(n) {
                            return function() {
                                return (
                                    (this.inAsync = t.inAsyncFunction),
                                    t.awaitAnywhere &&
                                        t.inAsyncFunction &&
                                        e.raise(
                                            node.start,
                        ...
                        e.extend("parseIdent", function(e) {
                            return function(n) {
                                return "module" === this.options.sourceType &&
                    ...
                    e.extend("parsePropertyName", function(e) {
                        return function(t) {
                            var r = t.key && t.key.name,
                                i = e.apply(this, arguments);
                            return (
                                "get" === this.value &&
                                    (t.__maybeStaticAsyncGetter = !0),
                                n[this.value]
                                    ? i
                                    : ("Identifier" !== i.type ||
                                      ("async" !== i.name && "async" !== r) ||
                                      (function(e, t) {
                                          return e.lineStart >= t;
                                      })(this, i.end) ||
                                      this.input.slice(i.end).match(s)
                                          ? delete t.__maybeStaticAsyncGetter
                                          : "set" === t.kind || "set" === i.name
                                              ? this.raise(
                                                    i.start,
                                                    "'set <member>(value)' cannot be be async"
                                                )
                                              : ((this.__isAsyncProp = !0),
                                                "Identifier" ===
                                                    (i = e.apply(
                                                        this,
                                                        arguments
                ...
                !(function(e, r) {
                    ...
                    function u(e, t) {
                        for (var n = 1, r = 0; ; ) {
                            T.lastIndex = r;
                            var i = T.exec(e);
                            if (!(i && i.index < t)) return new I(n, t - r);
                            ++n, (r = i.index + i[0].length);
                        }
                    }
                    function c(e) {
                        var t = {};
                        for (var n in D) t[n] = e && a(e, n) ? e[n] : D[n];
                        if (
                    ...
                    var E = [
                        ...
                        L = {
                            ...
                            _default: s("default", A),
                            _do: s("do", {isLoop: !0, beforeExpr: !0}),
                            _else: s("else", A),
                            _finally: s("finally"),
                            _for: s("for", {isLoop: !0}),
                            _function: s("function", C),
                            _if: s("if"),
                            _return: s("return", A),
                            _switch: s("switch"),
                            _throw: s("throw", A),
                    ...
                    var j = function(e, t, n) {
                        ...
                        V = function(e, t, n) {
                            (this.options = e = c(e)),
                                ...
                                (this.keywords = l(
                                    g[e.ecmaVersion >= 6 ? 6 : 5]
                                ));
                            var r = "";
                            if (!e.allowReserved) {
                                for (var i = e.ecmaVersion; !(r = y[i]); i--);
                                "module" == e.sourceType && (r += " await");
                            }
                            this.reservedWords = l(r);
                            var s = (r ? r + " " : "") + y.strict;
                            (this.reservedWordsStrict = l(s)),
                                (this.reservedWordsStrictBind = l(
                                    s + " " + y.strictBind
                                )),
                                (this.input = String(t)),
                                (this.containsEsc = !1),
                    ...
                    (V.prototype.isKeyword = function(e) {
                        return this.keywords.test(e);
                    }),
                        (V.prototype.isReservedWord = function(e) {
                            return this.reservedWords.test(e);
                        }),
                        (V.prototype.extend = function(e, t) {
                            this[e] = t(this[e]);
                        }),
                        (V.prototype.loadPlugins = function(e) {
                            for (var t in e) {
                                var n = M[t];
                                if (!n)
                                    throw new Error(
                    ...
                    (q.strictDirective = function(e) {
                        for (;;) {
                            ...
                            var t = U.exec(this.input.slice(e));
                            if (!t) return !1;
                        ...
                        (q.isContextual = function(e) {
                            return this.type === L.name && this.value === e;
                        }),
                        (q.eatContextual = function(e) {
                            return this.value === e && this.eat(L.name);
                        }),
                    ...
                    (z.isLet = function() {
                        ...
                        if (n(i, !0)) {
                            for (
                                var s = t + 1;
                                r(this.input.charCodeAt(s), !0);

                            )
                                ++s;
                            var o = this.input.slice(t, s);
                            if (!this.isKeyword(o)) return !0;
                        }
                        return !1;
                    }),
                        (z.isAsyncFunction = function() {
                            ...
                            var e = P.exec(this.input),
                                t = this.pos + e[0].length;
                            return !(
                                O.test(this.input.slice(this.pos, t)) ||
                                "function" !== this.input.slice(t, t + 8) ||
                                (t + 8 != this.input.length &&
                                    r(this.input.charAt(t + 8)))
                            );
                        }),
                            ...
                            switch (
                                ...
                                case L._import:
                                    return (
                                        ...
                                        i === L._import
                                            ? this.parseImport(s)
                                            : this.parseExport(s, n)
                                    );
                                default:
                                    if (this.isAsyncFunction() && e)
                                        return (
                                            this.next(),
                                    ...
                                    return i === L.name &&
                                        "Identifier" === a.type &&
                                        this.eat(L.colon)
                                        ? this.parseLabeledStatement(s, o, a)
                                        : this.parseExpressionStatement(s, a);
                            }
                        }),
                        ...
                        (z.parseFunctionStatement = function(e, t) {
                            return (
                                this.next(), this.parseFunction(e, !0, !1, t)
                            );
                        }),
                        (z.isFunction = function() {
                            return (
                                this.type === L._function ||
                    ...
                    (z.parseTryStatement = function(e) {
                        ...
                        return (
                            (e.finalizer = this.eat(L._finally)
                                ? this.parseBlock()
                                : null),
                            e.handler ||
                                e.finalizer ||
                        ...
                        (z.parseLabeledStatement = function(e, t, n) {
                            ...
                            for (
                                ...
                                (a.statementStart = this.start), (a.kind = s);
                            }
                            return (
                                this.labels.push({
                                    name: t,
                        ...
                        (z.parseVarId = function(e, t) {
                            (e.id = this.parseBindingAtom(t)),
                                this.checkLVal(e.id, t, !1);
                        }),
                        (z.parseFunction = function(e, t, n, r) {
                            this.initFunction(e),
                                this.options.ecmaVersion >= 6 &&
                                    !r &&
                                    (e.generator = this.eat(L.star)),
                                this.options.ecmaVersion >= 8 &&
                                    (e.async = !!r),
                                t &&
                                    ((e.id =
                        ...
                        (z.parseClass = function(e, t) {
                            ...
                            for (
                                ...
                                if (!this.eat(L.semi)) {
                                    ...
                                    if (
                                        (this.parseClassMethod(n, i, s, o), u)
                                    ) {
                        ...
                        (z.parseClassSuper = function(e) {
                            e.superClass = this.eat(L._extends)
                        ...
                        (z.checkPatternExport = function(e, t) {
                            ...
                            if ("Identifier" == n)
                                ...
                                for (
                                    ...
                                    var s = i[r];
                                    this.checkPatternExport(e, s.value);
                                }
                            else if ("ArrayPattern" == n)
                                for (
                                    var o = 0, a = t.elements;
                                    o < a.length;
                                    o += 1
                                ) {
                                    var u = a[o];
                        ...
                        (z.parseExportSpecifiers = function(e) {
                            ...
                            for (this.expect(L.braceL); !this.eat(L.braceR); ) {
                                if (n) n = !1;
                                    ...
                                    (this.expect(L.comma),
                                    this.afterTrailingComma(L.braceR))
                                )
                                    break;
                                var r = this.startNode();
                        ...
                        (z.adaptDirectivePrologue = function(e) {
                            for (
                                ...
                                e[t].directive = e[t].expression.raw.slice(
                                    1,
                                    -1
                                );
                        }),
                    ...
                    (H.toAssignable = function(e, t) {
                        ...
                        (H.toAssignableList = function(e, t) {
                            var n = e.length;
                            if (n) {
                                var r = e[n - 1];
                        ...
                        (H.parseBindingList = function(e, t, n) {
                            for (var r = [], i = !0; !this.eat(e); )
                                if (
                                    (i ? (i = !1) : this.expect(L.comma),
                                    t && this.type === L.comma)
                                )
                                    r.push(null);
                                else {
                        ...
                        (H.parseBindingListItem = function(e) {
                            return e;
                        }),
                        (H.parseMaybeDefault = function(e, t, n) {
                            if (
                            ...
                            switch (e.type) {
                                ...
                                case "ObjectPattern":
                                    for (
                                        ...
                                        var s = i[r];
                                        this.checkLVal(s.value, t, n);
                                    }
                                    break;
                                case "ArrayPattern":
                                    for (
                                        var o = 0, u = e.elements;
                                        o < u.length;
                                        o += 1
                                    ) {
                                        var c = u[o];
                                        c && this.checkLVal(c, t, n);
                                    }
                                    break;
                                case "AssignmentPattern":
                    ...
                    (Y.checkPropClash = function(e, t) {
                        ...
                        (Y.parseMaybeAssign = function(e, t, n) {
                            ...
                            if (
                                (n && (u = n.call(this, u, o, a)),
                                this.type.isAssign)
                            ) {
                                this.checkPatternErrors(t, !0), r || p.call(t);
                                var c = this.startNodeAt(o, a);
                                return (
                        ...
                        (Y.parseExprOp = function(e, t, n, r, i) {
                            ...
                            if (
                                ...
                                var u = this.start,
                                    ...
                                    p = this.buildBinary(t, n, e, l, a, o);
                                return this.parseExprOp(p, t, n, r, i);
                            }
                            return e;
                        }),
                        (Y.buildBinary = function(e, t, n, r, i, s) {
                        ...
                        (Y.parseMaybeUnary = function(e, t) {
                            var n,
                                r = this.start,
                                i = this.startLoc;
                        ...
                        (Y.parseExprSubscripts = function(e) {
                            var t = this.start,
                                n = this.startLoc,
                            ...
                            return (
                                e &&
                                    ...
                                    e.parenthesizedBind >= s.start &&
                                        (e.parenthesizedBind = -1)),
                                s
                            );
                        }),
                        (Y.parseSubscripts = function(e, t, n, r) {
                            for (
                                var i =
                                        this.options.ecmaVersion >= 8 &&
                                        "Identifier" === e.type &&
                                ...
                                if (
                                    ...
                                    if (this.type !== L.backQuote) return e;
                                    var f = this.startNodeAt(t, n);
                                    (f.tag = e),
                                        (f.quasi = this.parseTemplate({
                                            isTagged: !0
                                        })),
                                        (e = this.finishNode(
                                            f,
                        ...
                        (Y.parseExprAtom = function(e) {
                            ...
                            switch (this.type) {
                                ...
                                case L.parenL:
                                    var a = this.start,
                                        u = this.parseParenAndDistinguishExpression(
                                            n
                                        );
                                    return (
                                        e &&
                                            (e.parenthesizedAssign < 0 &&
                                                ...
                                                (e.parenthesizedAssign = a),
                                            e.parenthesizedBind < 0 &&
                                                (e.parenthesizedBind = a)),
                                        u
                                    );
                                case L.bracketL:
                                    return (
                        ...
                        (Y.parseParenAndDistinguishExpression = function(e) {
                            var t,
                                n = this.start,
                                r = this.startLoc,
                            ...
                            if (this.options.ecmaVersion >= 6) {
                                ...
                                for (
                                    ...
                                    if (
                                        (l ? (l = !1) : this.expect(L.comma),
                                        i &&
                                            this.afterTrailingComma(
                                                L.parenR,
                                                !0
                                            ))
                                    ) {
                                ...
                                if (
                                    ...
                                    return (
                                        ...
                                        (this.yieldPos = d),
                                        (this.awaitPos = y),
                                        this.parseParenArrowList(n, r, c)
                                    );
                                (c.length && !h) ||
                        ...
                        (Y.parseParenArrowList = function(e, t, n) {
                            return this.parseArrowExpression(
                    ...
                    (Y.parseNew = function() {
                        ...
                        (Y.parseObj = function(e, t) {
                            ...
                            for (
                                ...
                                this.checkPropClash(s, i), n.properties.push(s);
                            }
                            return this.finishNode(
                                n,
                        ...
                        (Y.parseProperty = function(e, t) {
                            ...
                            return (
                                ...
                                !n &&
                                this.isAsyncProp(o)
                                    ? ((r = !0), this.parsePropertyName(o, t))
                                    : (r = !1),
                                this.parsePropertyValue(o, e, n, r, i, s, t),
                                this.finishNode(o, "Property")
                            );
                        }),
                        (Y.parsePropertyValue = function(e, t, n, r, i, s, o) {
                            if (
                                ((n || r) &&
                                    this.type === L.colon &&
                                    this.unexpected(),
                        ...
                        (Y.parseArrowExpression = function(e, t, n) {
                        ...
                        (Y.parseFunctionBody = function(e, t) {
                            var n = t && this.type !== L.braceL,
                                r = this.strict,
                                i = !1;
                            if (n)
                    ...
                    var ee = function(e, t, n) {
                            (this.type = ""),
                                (this.start = t),
                                (this.end = 0),
                                e.options.locations && (this.loc = new j(e, n)),
                    ...
                    (te.startNode = function() {
                        ...
                        (te.startNodeAt = function(e, t) {
                            return new ee(this, e, t);
                        }),
                        (te.finishNode = function(e, t) {
                            return h.call(
                                this,
                                e,
                                t,
                        ...
                        (te.finishNodeAt = function(e, t, n, r) {
                    ...
                    (ie.initialContext = function() {
                        ...
                        (ie.braceIsBlock = function(e) {
                            ...
                            return (
                                ...
                                t === re.f_stat ||
                                (e !== L.colon ||
                                (t !== re.b_stat && t !== re.b_expr)
                                    ? e === L._return ||
                                      (e == L.name && this.exprAllowed)
                                        ? O.test(
                                              this.input.slice(
                                                  this.lastTokEnd,
                                                  this.start
                        ...
                        (L.braceL.updateContext = function(e) {
                            this.context.push(
                                this.braceIsBlock(e) ? re.b_stat : re.b_expr
                            ),
                                (this.exprAllowed = !0);
                        }),
                        (L.dollarBraceL.updateContext = function() {
                            this.context.push(re.b_tmpl),
                                (this.exprAllowed = !0);
                        }),
                        (L.parenL.updateContext = function(e) {
                            var t =
                                ...
                                e === L._with ||
                                e === L._while;
                            this.context.push(t ? re.p_stat : re.p_expr),
                                (this.exprAllowed = !0);
                        }),
                        (L.incDec.updateContext = function() {}),
                        (L._function.updateContext = L._class.updateContext = function(
                            e
                        ) {
                            e.beforeExpr &&
                            e !== L.semi &&
                            e !== L._else &&
                            ((e !== L.colon && e !== L.braceL) ||
                                this.curContext() !== re.b_stat)
                                ? this.context.push(re.f_expr)
                                : this.context.push(re.f_stat),
                                (this.exprAllowed = !1);
                        }),
                        (L.backQuote.updateContext = function() {
                            this.curContext() === re.q_tmpl
                                ? this.context.pop()
                                : this.context.push(re.q_tmpl),
                                (this.exprAllowed = !1);
                        }),
                        (L.star.updateContext = function(e) {
                            if (e == L._function) {
                                var t = this.context.length - 1;
                                this.context[t] === re.f_expr
                                    ? (this.context[t] = re.f_expr_gen)
                                    : (this.context[t] = re.f_gen);
                            }
                            this.exprAllowed = !0;
                        }),
                    ...
                    var se = function(e) {
                            (this.type = e.type),
                                ...
                                (this.end = e.end),
                                e.options.locations &&
                                    (this.loc = new j(e, e.startLoc, e.endLoc)),
                                e.options.ranges &&
                    ...
                    (oe.next = function() {
                        this.options.onToken &&
                            this.options.onToken(new se(this)),
                        ...
                        (oe.nextToken = function() {
                            ...
                            return (
                                ...
                                this.pos >= this.input.length
                                    ? this.finishToken(L.eof)
                                    : e.override
                                        ? e.override(this)
                                        : void this.readToken(
                                              this.fullCharCodeAtPos()
                                          )
                            );
                        }),
                        (oe.readToken = function(e) {
                            return n(e, this.options.ecmaVersion >= 6) ||
                                92 === e
                                ? this.readWord()
                        ...
                        (oe.skipLineComment = function(e) {
                            for (
                                ...
                                this.pos < this.input.length && !o(r);
                        ...
                        (oe.readToken_pipe_amp = function(e) {
                            ...
                            return t === e
                                ? this.finishOp(
                                      124 === e ? L.logicalOR : L.logicalAND,
                                      2
                                  )
                                : 61 === t
                                    ? this.finishOp(L.assign, 2)
                        ...
                        (oe.getTokenFromCode = function(e) {
                            switch (e) {
                                ...
                                case 40:
                                    return (
                                        ++this.pos, this.finishToken(L.parenL)
                                    );
                                case 41:
                                    return (
                                        ++this.pos, this.finishToken(L.parenR)
                                    );
                                case 59:
                                    return ++this.pos, this.finishToken(L.semi);
                                case 44:
                                    return (
                                        ++this.pos, this.finishToken(L.comma)
                                    );
                                case 91:
                                    return (
                                        ++this.pos, this.finishToken(L.bracketL)
                                    );
                                case 93:
                                    return (
                                        ++this.pos, this.finishToken(L.bracketR)
                                    );
                                case 123:
                                    return (
                                        ++this.pos, this.finishToken(L.braceL)
                                    );
                                case 125:
                                    return (
                                        ++this.pos, this.finishToken(L.braceR)
                                    );
                                case 58:
                                    return (
                                        ++this.pos, this.finishToken(L.colon)
                                    );
                                case 63:
                                    return (
                                        ++this.pos, this.finishToken(L.question)
                                    );
                                case 96:
                                    if (this.options.ecmaVersion < 6) break;
                                    return (
                                        ++this.pos,
                                        this.finishToken(L.backQuote)
                                    );
                                case 48:
                                    var t = this.input.charCodeAt(this.pos + 1);
                                    if (120 === t || 88 === t)
                    ...
                    (oe.readRegexp = function() {
                        ...
                        if (o) {
                            var c = /^[gim]*$/;
                            this.options.ecmaVersion >= 6 && (c = /^[gimuy]*$/),
                                c.test(o) ||
                                    this.raise(
                                        r,
                        ...
                        var l = null;
                        return (
                            ae || (f(a, u, r, this), (l = f(s, o))),
                            this.finishToken(L.regexp, {
                                pattern: s,
                                flags: o,
                                value: l
                            })
                        ...
                        (oe.readRadixNumber = function(e) {
                            ...
                            return (
                                ...
                                this.finishToken(L.num, t)
                            );
                        }),
                        (oe.readNumber = function(e) {
                            var t = this.pos,
                                r = !1,
                                i = 48 === this.input.charCodeAt(this.pos);
                            e ||
                            ...
                            for (var e = "", t = this.pos; ; ) {
                                ...
                                if (
                                    ...
                                    return this.pos !== this.start ||
                                        (this.type !== L.template &&
                                            this.type !== L.invalidTemplate)
                                        ? ((e += this.input.slice(t, this.pos)),
                                          this.finishToken(L.template, e))
                                        : 36 === n
                                            ? ((this.pos += 2),
                                              this.finishToken(L.dollarBraceL))
                                            : (++this.pos,
                                              this.finishToken(L.backQuote));
                                if (92 === n)
                                    (e += this.input.slice(t, this.pos)),
                    ...
                    (e.version = "5.2.1"),
                        ...
                        (e.TokContext = ne),
                        (e.tokContexts = re),
                        (e.isIdentifierChar = r),
                        (e.isIdentifierStart = n),
                        (e.Token = se),
                        (e.isNewLine = o),
                        (e.lineBreak = O),
                        (e.lineBreakG = T),
                        (e.nonASCIIwhitespace = N),
            ...
            function(e, t, n) {
                !(function(e, r) {
                    ...
                    (o.Program = o.BlockStatement = function(e, t, n) {
                        ...
                        (o.Statement = n),
                        (o.EmptyStatement = r),
                        (o.ExpressionStatement = o.ParenthesizedExpression = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.BreakStatement = o.ContinueStatement = r),
                        ...
                        (o.ReturnStatement = o.YieldExpression = o.AwaitExpression = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.ThrowStatement = o.SpreadElement = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.CatchClause = function(e, t, n) {
                            n(e.param, t, "Pattern"), n(e.body, t, "ScopeBody");
                        }),
                        (o.WhileStatement = o.DoWhileStatement = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.ForInStatement = o.ForOfStatement = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.Function = function(e, t, n) {
                            ...
                            n(
                                e.body,
                                t,
                                e.expression ? "ScopeExpression" : "ScopeBody"
                            );
                        }),
                        ...
                        (o.ObjectPattern = function(e, t, n) {
                            for (
                                ...
                                n(i[r].value, t, "Pattern");
                            }
                        }),
                        (o.Expression = n),
                        (o.ThisExpression = o.Super = o.MetaProperty = r),
                        ...
                        (o.FunctionExpression = o.ArrowFunctionExpression =
                            o.FunctionDeclaration),
                        (o.SequenceExpression = o.TemplateLiteral = function(
                            e,
                            t,
                            n
                        ) {
                            for (
                                var r = 0, i = e.expressions;
                                r < i.length;
                                r += 1
                            ) {
                                n(i[r], t, "Expression");
                        ...
                        (o.UnaryExpression = o.UpdateExpression = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.BinaryExpression = o.LogicalExpression = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.AssignmentExpression = o.AssignmentPattern = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.NewExpression = o.CallExpression = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.ExportNamedDeclaration = o.ExportDefaultDeclaration = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.ImportSpecifier = o.ImportDefaultSpecifier = o.ImportNamespaceSpecifier = o.Identifier = o.Literal = r),
                        (o.TaggedTemplateExpression = function(e, t, n) {
                            n(e.tag, t, "Expression"), n(e.quasi, t);
                        }),
                        (o.ClassDeclaration = o.ClassExpression = function(
                            e,
                            t,
                            n
                        ) {
                        ...
                        (o.Class = function(e, t, n) {
                            e.id && n(e.id, t, "Pattern"),
                                e.superClass &&
                                    n(e.superClass, t, "Expression");
                            for (
                                var r = 0, i = e.body.body;
                                r < i.length;
                                r += 1
                            ) {
                                n(i[r], t);
                        ...
                        (e.fullAncestor = function(t, n, r, i) {
                            r || (r = e.base);
                            var s = [];
                            !(function e(t, i, o) {
                                var a = o || t.type,
                        ...
                        (e.findNodeAt = function(n, r, s, o, a, u) {
                            (o = t(o)), a || (a = e.base);
                            try {
                                !(function e(t, n, u) {
                                    var c = u || t.type;
                        ...
                        (e.findNodeAround = function(n, r, s, o, a) {
                            (s = t(s)), o || (o = e.base);
                            try {
                                !(function e(t, n, a) {
                                    var u = a || t.type;
                        ...
                        (e.findNodeAfter = function(n, r, s, o, a) {
                            (s = t(s)), o || (o = e.base);
                            try {
                                !(function e(t, n, a) {
                                    if (!(t.end < r)) {
                        ...
                        (e.findNodeBefore = function(n, r, s, o, a) {
                            (s = t(s)), o || (o = e.base);
                            var u;
                            return (
                                (function e(t, n, a) {
                ...
                (n.byteLength = function(e) {
                    ...
                    (n.fromByteArray = function(e) {
                        for (
                            ...
                            a.push(s(e, u, u + 16383 > c ? c : u + 16383));
                        return (
                            1 === r
                                ? ((t = e[n - 1]),
                                  (i += o[t >> 2]),
        ...
        8: [
            function(e, t, n) {
                ...
                function l(e, t) {
                    ...
                    if (N(e) || T(e)) return e.byteLength;
                    "string" != typeof e && (e = "" + e);
                    var n = e.length;
                    if (0 === n) return 0;
                    for (var r = !1; ; )
                ...
                function f(e, t, n, r, s) {
                    ...
                    if (
                        ...
                        return 0 === t.length ? -1 : d(e, t, n, r, s);
                    if ("number" == typeof t)
                        return (
                            (t &= 255),
                ...
                function L(e) {
                    return F.toByteArray(
                        (function(e) {
                            if ((e = e.trim().replace(I, "")).length < 2)
                                return "";
                            for (; e.length % 4 != 0; ) e += "=";
                            return e;
                        })(e)
                ...
                (n.kMaxLength = B),
                    ...
                    (i.prototype.compare = function(e, t, n, r, s) {
                        if (!i.isBuffer(e))
                            throw new TypeError("Argument must be a Buffer");
                        if (
                            (void 0 === t && (t = 0),
                            ...
                            t < 0 || n > e.length || r < 0 || s > this.length)
                        )
                ...
                (i.prototype.slice = function(e, t) {
                    ...
                    (i.prototype.writeUIntLE = function(e, t, n, r) {
                        if (((e = +e), (t >>>= 0), (n >>>= 0), !r)) {
                            S(this, e, t, n, Math.pow(2, 8 * n) - 1, 0);
                        }
                        var i = 1,
                            s = 0;
            ...
            function(e, t, n) {
                (function(n) {
                    ...
                    function i(e) {
                        (this.covers = {}),
                            (this._ident =
                                i.prototype.version + "_" + Math.random()),
                            this.setOptions(e || {});
                    }
                    var s = e("./lib/parser"),
                        o = e("./lib/arboriculture"),
                        a = e("./lib/output");
                    (i.prototype.smCache = {}),
                        (i.prototype.setOptions = function(e) {
                            return (
                                (this.log =
                                    !1 === e.log ? r : e.log || this.log),
                        ...
                        (i.prototype.version = e("./package.json").version),
                        (i.prototype.isThenable = function(e) {
                            return (
                                e &&
                                e instanceof Object &&
                        ...
                        (i.prototype.compile = function(e, t, n, s) {
                            "object" == typeof n && void 0 === s && (s = n),
                                (s = s || {});
                            for (var o in i.initialCodeGenOpts)
                                o in s || (s[o] = i.initialCodeGenOpts[o]);
                            var a = this.parse(e, t, null, s);
                            return (
                                this.asynchronize(a, null, s, this.log || r),
                                this.prettyPrint(a, s),
                                a
                            );
                        }),
                        (i.prototype.parse = function(e, t, n, r) {
                            "object" == typeof n && void 0 === r && (r = n);
                            var i = {origCode: e.toString(), filename: t};
                            try {
                                return (
                                    (i.ast = s.parse(
                                        i.origCode,
                                    ...
                                    r.babelTree &&
                                        s.treeWalker(i.ast, function(e, t, n) {
                                            "Literal" === e.type
                                                ? n[0].replace(
                                                      o.babelLiteralNode(
                                                          e.value
                        ...
                        (i.prototype.asynchronize = o.asynchronize),
                        (i.prototype.printNode = o.printNode),
                        (i.prototype.prettyPrint = function(t, r) {
                            var i = t.filename
                                    ? t.filename.split("/")
                                    : ["anonymous"],
                                s = i.pop(),
                                        ...
                                        ? {
                                              map: {
                                                  startLine:
                                                      r.mapStartLine || 0,
                                                  file: s + "(original)",
                                                  sourceMapRoot: i.join("/"),
                                                  sourceContent: t.origCode
                                              }
                                          }
                                        : null,
                                    t.origCode
                        ...
                        (i.prototype.getDefaultCompileOptions = void 0),
                        Object.defineProperty(i.prototype, "Promise", {
                            get: function() {
                                return (
                                    initOpts.log(
                                        "Warning: nodent.Promise is deprecated. Use nodent.Thenable instead"
                                    ),
                                    Thenable
                                );
                            },
        ...
        11: [
            function(e, t, n) {
                ...
                function s(e, t) {
                    e !== t &&
                        ((e.__proto__ = Object.getPrototypeOf(t)),
                ...
                function u(e, t, n) {
                    ...
                    try {
                        y.treeWalker(e, function(n, r, i) {
                            if (t(n)) throw ((s.path = i), s);
                            (n === e || c(n)) && r();
                        });
                    } catch (e) {
                        if (e === s) return s.path;
                        throw e;
                    }
                    return null;
                }
                function c(e) {
                    return u(e, function(e) {
                        return "AwaitExpression" === e.type && !e.$hidden;
                    });
                }
                function l(e) {
                    return u(
                        ...
                        function(e) {
                            var t = a(e);
                            return !t.isBlockStatement && !t.isScope;
                        }
                    );
                }
                function p(e) {
                ...
                function h(e, t) {
                    return {type: "Identifier", name: e, loc: t};
                }
                function f(e) {
                    var t = {};
                    for (var n in e)
                        t[n] = "string" == typeof e[n] ? h(e[n]) : e[n];
                    return t;
                }
                function d(e, t, n, d) {
                    function m(e, t) {
                        if (
                            ...
                            !e.id &&
                            !t &&
                            0 === e.type.indexOf("Function")
                        )
                            return (e.type = "ArrowFunctionExpression"), e;
                        if (n.noRuntime) {
                            if (t) {
                                if (a(t).isLiteral)
                                    throw new Error(
                                        "Nodent: 'noRuntime' option only compatible with -promise and -engine modes"
                                    );
                                e.body.body = y.part(
                                    "try {$:0} catch($2) {return $1($2)}",
                                    [i(e.body), t, h("$boundEx")]
                                ).body;
                            } else if (
                                n.es6target &&
                                !e.id &&
                                ...
                                return (e.type = "ArrowFunctionExpression"), e;
                            return n.es6target && !e.id
                                ? ((e.type = "ArrowFunctionExpression"), e)
                                : y.part("$0.bind(this)", [e]).expr;
                        }
                        return t
                            ? y.part("$0.$1(this,$2)", [e, pe.asyncbind, t])
                                  .expr
                            : y.part("$0.$1(this)", [e, pe.asyncbind]).expr;
                    }
                    function g(e, t, n, r) {
                        return y.part("var $0 = $1", [
                            h(e),
                            m(
                                {
                    ...
                    function w(e, t) {
                        if (!a(e).isFunction)
                            throw new Error(
                                "Can only replace 'arguments' in functions"
                            );
                        return (
                            "$usesArguments" in e ||
                                (y.treeWalker(e, function(t, r, i) {
                                    "Identifier" === t.type &&
                                    "arguments" === t.name
                                        ? (i[0].parent.shorthand &&
                                              ((i[0].parent.shorthand = !1),
                                              (i[0].parent.key = h(
                                                  "arguments"
                                              )),
                                              (e.$usesArguments = !0)),
                                ...
                                (e.$usesArguments = e.$usesArguments || !1)),
                            e.$usesArguments &&
                    ...
                    function E(e) {
                        return (
                            "string" != typeof e &&
                                (e = e.type.replace(
                                    /Statement|Expression/g,
                                    ""
                                )),
                            n.generatedSymbolPrefix + e + "_" + le++
                        );
                    }
                    function S(e, t) {
                        return (
                    ...
                    function k(e, t) {
                        var n = (function(e) {
                            for (var t = 0; t < e.length; t++) {
                                if (e[t].self.$exit) return e[t].self;
                                if (e[t].parent && e[t].parent.$exit)
                                    return e[t].parent;
                            }
                            return null;
                        })(e);
                    ...
                    function A(e, t) {
                        var r =
                            !(n.promises || n.generators || n.engine) &&
                            n.lazyThenables;
                        ie(e),
                            ne(e),
                            j(e),
                    ...
                    function C(e, t) {
                        var n = {
                            ...
                            type: e
                                ? "FunctionDeclaration"
                                : "FunctionExpression",
                            id: e ? ("string" == typeof e ? h(e) : e) : void 0,
                            params: [],
                            body: {type: "BlockStatement", body: i(t)}
                        };
                        return e && (ce[e] = {def: n}), n;
                    }
                    function _(e) {
                        return {
                    ...
                    function L(e, t) {
                        ...
                        var n = y.part("$0.call($1)", [
                            e,
                            [{type: "ThisExpression"}].concat(t || [])
                        ]).expr;
                        return (e.$thisCall = n), (n.$thisCallName = e.name), n;
                    }
                    function O(e, t) {
                        return {type: "ReturnStatement", argument: L(e, t)};
                    }
                    function T(e, t) {
                        return {
                            type: "CallExpression",
                            callee: h(e.$seh + "Finally"),
                            arguments: t ? [t] : []
                        };
                    }
                    function N(e, t) {
                        ...
                        return y.treeWalker(
                            e,
                            function(e, t, s) {
                                if ("ReturnStatement" !== e.type || e.$mapped) {
                                ...
                                if (r > 0) {
                                    if (!a(e).isAsync) return t(e);
                                    delete e.async;
                                }
                                return (
                                    (e.$mapped = !0),
                                    void (a(e.argument).isUnaryExpression &&
                                    "void" === e.argument.operator
                                        ? (e.argument = e.argument.argument)
                                        : (e.argument = {
                                              type: "CallExpression",
                                              callee: k(s, [n]).$return,
                                              arguments: e.argument
                    ...
                    function $(e, t, n) {
                        if ("SwitchCase" !== e.type && a(e).isBlockStatement)
                            for (var r = 0; r < e.body.length; ) {
                                var i = e.body[r];
                                if (
                                    "SwitchCase" !== i.type &&
                                    a(i).isBlockStatement
                                ) {
                                    if (ae(i.body))
                                        if (l(i)) {
                                            var s = E(i),
                    ...
                    function B(e, t, n) {
                        if (
                            "IfStatement" === e.type &&
                            c([e.consequent, e.alternate])
                        ) {
                            var r = E(e),
                                o = t[0],
                                u = {type: "BlockStatement", body: [e]};
                            if ("index" in o) {
                                var l = o.index,
                                    p = o.parent[o.field].splice(
                                        l + 1,
                                        o.parent[o.field].length - (l + 1)
                                    );
                                if ((o.replace(u), p.length)) {
                                    var h = O(r);
                                    u.body.push(n(C(r, p))),
                                        [e.consequent, e.alternate].forEach(
                                            function(e) {
                                                if (e) {
                                                    var t;
                                                    ((t = a(e).isBlockStatement
                                                        ? e.body[
                                                              e.body.length - 1
                                                          ]
                                                        : e) &&
                                        ...
                                        (e.consequent &&
                                            e.alternate &&
                                            e.consequent.$deferred &&
                                            e.alternate.$deferred) ||
                                            u.body.push(i(h));
                                }
                            } else o.parent[o.field] = u;
                        }
                    }
                    function R(e, t, n) {
                        if (
                            ...
                            if ("index" in a) {
                                var u = a.index + 1;
                                (o = a.parent[a.field].splice(
                                    u,
                                    a.parent[a.field].length - u
                                )).length &&
                                    "BreakStatement" === o[o.length - 1].type &&
                                    a.parent[a.field].push(o.pop()),
                                    (r = E(e)),
                                    (s = O(r)),
                                    a.parent[a.field].unshift(C(r, o)),
                                    a.parent[a.field].push(i(s));
                            }
                            return (
                                e.cases.forEach(function(e, t) {
                                    if ("SwitchCase" !== e.type)
                                        throw new Error(
                                            "switch contains non-case/default statement: " +
                                                e.type
                                        );
                                    if (c(e.consequent)) {
                                        var n =
                                        ...
                                        "BreakStatement" === n.type
                                            ...
                                            : "ReturnStatement" === n.type ||
                                              ...
                                              (d(
                                                  v(e) +
                                                      "switch-case fall-through not supported - added break. See https://github.com/MatAtBread/nodent#differences-from-the-es7-specification"
                                              ),
                                              e.consequent.push(i(s)));
                                    }
                                }),
                                !0
                            );
                    ...
                    function j(t, r) {
                        return (
                            y.treeWalker(t, function(t, i, s) {
                                if (
                                    "TryStatement" === t.type &&
                                    !t.$seh &&
                                    (a(s[0].parent).isBlockStatement ||
                                        (s[0].parent[s[0].field] = {
                                            type: "BlockStatement",
                                            body: [t]
                                        }),
                                    (t.$seh = E("Try") + "_"),
                                    (t.$containedAwait = !!c(t)),
                                    (t.$finallyExit =
                                        t.finalizer &&
                                        (function(e) {
                                            for (var t = 0; t < e.length; t++)
                                                if (a(e[t].self).isFunction)
                                                    return (
                                                        e[t].self.async ||
                                                        e[t].self.$wasAsync
                                                    );
                                        ...
                                        !!u(t.finalizer.body, I)),
                                    t.$containedAwait || t.$finallyExit)
                                ) {
                                    t.$needsMapping = !r || !t.$finallyExit;
                                    var o = k(s, [n]);
                                    if (t.finalizer && !t.handler) {
                                        var l = h(E("exception"));
                                        t.handler = {
                                            type: "CatchClause",
                                            param: l,
                                    ...
                                    if (!t.handler && !t.finalizer) {
                                        var p = new SyntaxError(
                                            v(t.value) +
                                                "try requires catch and/or finally clause",
                                            e.filename,
                                            t.start
                                        );
                                        throw ((p.pos = t.start),
                    ...
                    function D(e, t) {
                        for (var n = 0; n < e.length; n++)
                            if (!a(e[n]).isDirective)
                                return void e.splice.apply(e, [n, 0].concat(t));
                        e.splice.apply(e, [e.length, 0].concat(t));
                    }
                    function M(t, r, s) {
                        if (t.$needsMapping) {
                            var o,
                            ...
                            if (!("index" in c))
                                throw new Error(
                                    e.filename + " - malformed try/catch blocks"
                                );
                            var l = c.index + 1,
                                p = c.parent[c.field].splice(
                                    l,
                                    c.parent[c.field].length - l
                                );
                            if (p.length) {
                                var f = s(
                                    g(
                                ...
                                c.parent[c.field].splice(c.index, 0, f),
                                    (o = y.part("return $0()", [
                                        t.finalizer ? T(t, h(a)) : h(a)
                                    ]).body[0]);
                            } else t.finalizer && (o = O(T(t)));
                            (t.$mapped = !0),
                                o &&
                                    (t.block.body.push(i(o)),
                                    t.handler.body.body.push(i(o)));
                            var d = k(r, [n]);
                            if (t.handler) {
                                var v = h(t.$seh + "Catch");
                                u = i(t.handler.body);
                                var b = g(
                                    ...
                                    u,
                                    [i(t.handler.param)],
                                    t.finalizer ? T(t, d.$error) : d.$error
                                );
                                (t.handler.body.body = [
                                    {
                                        type: "CallExpression",
                                        callee: v,
                                        arguments: [i(t.handler.param)]
                                    }
                                ]),
                                    c.parent[c.field].splice(c.index, 0, b);
                            }
                            if (t.finalizer) {
                                s(t.finalizer);
                                var x = {
                                        exit: h(t.$seh + "Exit"),
                                        value: h(t.$seh + "Value"),
                                        body: i(t.finalizer.body)
                                    },
                                    w = y.part(
                                        "(function ($value) {                                             $:body;                                                  return $exit && ($exit.call(this, $value));           })",
                                        x
                                    ).expr,
                                    E = {
                                ...
                                D(c.parent[c.field], [E]);
                                var S = y.part("return $0()", [
                                    t.finalizer ? T(t, h(a)) : h(a)
                                ]).body[0];
                                (u.body[u.length - 1] = S),
                                    (t.block.body[t.block.body.length - 1] = S),
                                    delete t.finalizer;
                            }
                        }
                    }
                            ...
                            y.treeWalker(e, function(e, u, l) {
                                if (
                                    ...
                                    if (
                                        ...
                                        var f =
                                            v(e) +
                                            "'await' used inside non-async function. ";
                                        n.promises
                                            ? (f +=
                                                  "'return' value Promise runtime-specific")
                                            : (f +=
                                                  "'return' value from await is synchronous"),
                                            d(
                                                f +
                                                    ". See https://github.com/MatAtBread/nodent#differences-from-the-es7-specification"
                                            );
                                    }
                                    var y = l[0].parent;
                                    "LogicalExpression" === y.type &&
                                        y.right === e &&
                                        d(
                                            v(e.argument) +
                                                "'" +
                                    ...
                                    var g = h(E("await")),
                                        b = i(e.argument);
                                    s(e, g);
                                    for (var x, w, S = 1; S < l.length; S++)
                                        if (
                                            (w = a(l[S].self).isBlockStatement)
                                        ) {
                                            x = l[S - 1];
                                            break;
                                        }
                                    if (!x)
                                        throw new Error(
                                            v(e) +
                                                "Illegal await not contained in a statement"
                                        );
                                    var A,
                                        C,
                                        _ = k(l, [o, n]),
                                        L = x.index,
                                        O = w.splice(L, w.length - L).slice(1);
                                    "ReturnStatement" === x.self.type &&
                                    "CallExpression" === x.self.argument.type &&
                                    1 === x.self.argument.arguments.length &&
                                    x.self.argument.arguments[0].name === g.name
                                        ? (C = A = x.self.argument.callee)
                                        : "Identifier" === x.self.type ||
                                          x.self.name === g.name ||
                                          ("ExpressionStatement" ===
                                              x.self.type &&
                                              "Identifier" ===
                                                  x.self.expression.type &&
                                              x.self.expression.name === g.name)
                                            ? (A = O.length
                                                  ? {
                                                        type:
                                                            "FunctionExpression",
                    ...
                    function U(e, t) {
                        ...
                        for (var c = 0; c < t.length; c++)
                            if (a(t[c].parent).isBlockStatement) {
                                t[c].parent[t[c].field].splice(
                                    t[c].index,
                                    0,
                                    o[0],
                                    o[1]
                    ...
                    function z(e, t) {
                        "BlockStatement" !== e.body.type &&
                            (e.body = {type: "BlockStatement", body: [e.body]});
                        var n,
                            r,
                            i = y.part("[$0[Symbol.iterator]()]", [e.right])
                                .expr;
                        if ("VariableDeclaration" === e.left.type) {
                            "const" === e.left.kind && (e.left.kind = "let"),
                                (n = e.left.declarations[0].id);
                            var s = te(e.left.declarations[0].id);
                            (r = h(E("iterator_" + s.join("_")))),
                                (e.left.declarations = s.map(function(e) {
                                    return {
                                        type: "VariableDeclarator",
                                        id: h(e)
                                    };
                                })),
                                e.left.declarations.push({
                                    type: "VariableDeclarator",
                                    id: r,
                                    init: i
                                }),
                    ...
                    function W(e, t, r) {
                        ...
                        "ForInStatement" === e.type && c(e)
                            ? U(e, t)
                            : "ForOfStatement" === e.type && c(e) && z(e);
                        var s = t.some(function(e) {
                            return (
                                "$label" in e.self &&
                                "ForStatement" === e.self.type &&
                                e.self.$mapped
                            );
                        });
                        if (
                            ...
                            var m, g;
                            e.$label
                                ? ((g = e.$label.name), (m = t[1]))
                                : ((g = le++), (m = t[0]));
                            var v,
                                x,
                                w = h(
                                    (g =
                                        n.generatedSymbolPrefix + "Loop_" + g) +
                                        "_trampoline"
                                ),
                                E = h(g),
                                S = f ? h(g + "_step") : E,
                            ...
                            if ("index" in m) {
                                var _ = m.index;
                                x = m.parent[m.field].splice(
                                    _ + 1,
                                    m.parent[m.field].length - (_ + 1)
                                );
                            } else x = [];
                            v = C(A, x);
                            var L = {type: "ReturnStatement", argument: E},
                                O = {type: "ReturnStatement", argument: S},
                                T = {
                                    type: "ReturnStatement",
                                    argument: {
                            ...
                            (N = n.noRuntime
                                ? y.part(
                                      n.es6target
                                          ? "($idTrampoline = ((q) => {     $$setMapped: while (q) {          if (q.then)  " +
                                            (1 === i
                                                ? "             return void q.then($idTrampoline, $exit); "
                                                : "             return q.then($idTrampoline, $exit); ") +
                                            "         try {              if (q.pop)                   if (q.length)                   return q.pop() ? $idContinuation.call(this) : q;               else                   q = $idStep;               else                   q = q.call(this)           } catch (_exception) {              return $exit(_exception);           }      } }))($idIter)"
                                          : "($idTrampoline = (function (q) {     $$setMapped: while (q) {          if (q.then)  " +
                                            (1 === i
                                                ? "             return void q.then($idTrampoline, $exit); "
                                                : "             return q.then($idTrampoline, $exit); ") +
                                            "         try {              if (q.pop)                   if (q.length)                   return q.pop() ? $idContinuation.call(this) : q;               else                   q = $idStep;               else                   q = q.call(this)           } catch (_exception) {              return $exit(_exception);           }      } }).bind(this))($idIter)",
                                      {
                                          setMapped: function(e) {
                                              return (e.$mapped = !0), e;
                                          },
                                          idTrampoline: w,
                                          exit: P,
                                ...
                                : y.part(
                                      "(Function.$0.trampoline(this,$1,$2,$3,$5)($4))",
                                      [pe.asyncbind, A, S, P, E, b(1 === i)]
                                  ).expr),
                                o.push({type: "ReturnStatement", argument: N}),
                                o.push({
                                    $label: e.$label,
                                    type: "FunctionDeclaration",
                                    id: E,
                                    params: [],
                                    body: {type: "BlockStatement", body: d}
                                }),
                                f &&
                                    o.push({
                                        type: "FunctionDeclaration",
                                ...
                                !l ||
                                "VariableDeclaration" !== l.type ||
                                ("let" !== l.kind && "const" !== l.kind)
                                    ? (o.push(v), t[0].replace(o.map(r)))
                                    : ("const" === l.kind && (l.kind = "let"),
                                      t[0].replace([
                                          {
                                              type: "BlockStatement",
                                              body: o.map(r)
                    ...
                    function G(e) {
                        if (!a(e).isFunction)
                            throw new Error(
                                "Cannot examine non-Function node types for async exits"
                            );
                        return u(
                            e.body,
                            function(e) {
                            ...
                            function(e) {
                                return !(
                                    a(e).isFunction &&
                                    (e.$wasAsync || a(e).isAsync)
                                );
                            }
                        );
                    }
                    function J(t) {
                        return y.treeWalker(t, function(t, r, i) {
                            var s = x(t);
                            if ((r(), s && a(s).isAsync)) {
                                if ("set" == t.kind) {
                                    var o = new SyntaxError(
                                        v(s) +
                                            "method 'async set' cannot be invoked",
                                        e.filename,
                                        t.start
                                    );
                                    throw ((o.pos = t.start),
                                ...
                                var u = w(s);
                                G(s) ||
                                    (0 !== s.body.body.length &&
                                        "ReturnStatement" ===
                                            s.body.body[s.body.body.length - 1]
                                                .type) ||
                                    s.body.body.push({type: "ReturnStatement"});
                                var c = m(
                                    S(
                                        {
                                            type: "FunctionExpression",
                                            params: [pe.return, pe.error],
                                            body: J(N(s.body, i)),
                                            $wasAsync: !0
                                        },
                                        n
                    ...
                    function H(e) {
                        return (
                            y.treeWalker(e, function(e, t, r) {
                                if ((t(), a(e).isAsync && a(e).isFunction)) {
                                    var i;
                                    (i = x(r[0].parent)) &&
                                        a(i).isAsync &&
                                        "get" === r[0].parent.kind &&
                    ...
                    function Y(e) {
                        ...
                        var t = 0;
                        return y.treeWalker(e, function(e, n, r) {
                            if (
                                ("ThrowStatement" !== e.type &&
                                    "ReturnStatement" !== e.type) ||
                                e.$mapped
                            ) {
                                if (a(e).isFunction) return t++, n(e), void t--;
                            } else if (t > 0 && a(e).isAsync) return delete e.async, (e.argument = {type: "CallExpression", callee: "ThrowStatement" === e.type ? pe.error : pe.return, arguments: e.argument ? [e.argument] : []}), void (e.type = "ReturnStatement");
                            n(e);
                        });
                    }
                    function Q(e, t) {
                        ...
                        return y.part(
                            "{ return (function*($return,$error){ $:body }).$asyncspawn(Promise,this) }",
                            {
                                return: pe.return,
                                error: pe.error,
                                asyncspawn: pe.asyncspawn,
                                body: Y(e).concat(
                                    t
                                        ? [
                                              {
                    ...
                    function X(e) {
                        e.$asyncgetwarninig ||
                            ((e.$asyncgetwarninig = !0),
                            d(
                                v(e) +
                                    "'async get " +
                                    r(e) +
                                    "(){...}' is non-standard. See https://github.com/MatAtBread/nodent#differences-from-the-es7-specification"
                            ));
                    }
                    function Z(e, t) {
                        function r(e, t) {
                        ...
                        function o(e) {
                            var t = n.promises;
                            (n.promises = !0), A(e, !0), (n.promises = t);
                        }
                        function u(e) {
                            return (
                                "BlockStatement" !== e.body.type &&
                            ...
                            n.$asyncexitwarninig ||
                                ...
                                d(
                                    v(e) +
                                        ...
                                        "' not possible in " +
                                        (t ? "engine" : "generator") +
                                        " mode. Using Promises for function at " +
                                        v(n)
                                ));
                        }
                        y.treeWalker(e, function(e, n, i) {
                            n();
                            var l, p, h;
                            if (a(e).isAsync && a(e).isFunction) {
                                var f;
                                (f = x(i[0].parent)) &&
                                    a(f).isAsync &&
                                    "get" === i[0].parent.kind &&
                                            ...
                                            : (delete (l = e).async,
                                              ...
                                              "ExpressionStatement" ===
                                                  ...
                                                  ? ((l.type =
                                                    ...
                                                    i[1].replace(l))
                                                  : i[0].replace(l));
                            } else (l = x(e)) && a(l).isAsync && ((p = G(l)) ? (c(p, l), o(e)) : (t && "get" !== e.kind) || (t ? o(e) : ((e.async = !1), (h = w(l)), r(l, !1), s(l, u(l)), (l.body = Q(l.body.body, p))), h && D(l.body.body, [he])));
                        });
                        var l = i(n);
                        return (
                            (n.engine = !1),
                    ...
                    function ee(e, t) {
                        ...
                        if (
                            ...
                            e.forEach(function(e) {
                                function t(e) {
                                    e in s
                                        ? (r[e] = o.declarations[u])
                                        : (s[e] = o.declarations[u]);
                                }
                                for (
                                    var n = e[0],
                                        o = n.self,
                                        a = (o.kind, []),
                                        u = 0;
                                    u < o.declarations.length;
                                    u++
                                ) {
                                    var c = o.declarations[u];
                                    if ((te(c.id).forEach(t), c.init)) {
                                        var l = {
                            ...
                            o.length &&
                                ...
                                n[0] && "VariableDeclaration" === n[0].type
                                    ? (n[0].declarations = n[0].declarations.concat(
                                          o
                                      ))
                                    : n.unshift({
                                          type: "VariableDeclaration",
                        ...
                        return {decls: n, duplicates: r};
                    }
                    function te(e) {
                        if (!e) return [];
                        if (Array.isArray(e))
                            return e.reduce(function(e, t) {
                                return e.concat(te(t.id));
                            }, []);
                        switch (e.type) {
                            case "Identifier":
                                return [e.name];
                            case "AssignmentPattern":
                                return te(e.left);
                            case "ArrayPattern":
                                return e.elements.reduce(function(e, t) {
                                    return e.concat(te(t));
                                }, []);
                            case "ObjectPattern":
                                return e.properties.reduce(function(e, t) {
                                    return e.concat(te(t));
                                }, []);
                            case "ObjectProperty":
                            case "Property":
                    ...
                    function ne(e) {
                        ...
                        function o(e, t) {
                            return (
                                !("FunctionDeclaration" !== e.type || !e.id) &&
                                (a(e).isAsync || !e.$continuation)
                            );
                        }
                        var l = {
                                ...
                                for (u = 0; u < p.length; u++)
                                    if (!a(p[u]).isScope) {
                                        if (
                                            ...
                                            break;
                                        (r = t(p[u])) && h.push(r[0].self);
                                    }
                            } else if ("VariableDeclaration" === e.type)
                                for (u = e.declarations.length - 1; u > 0; u--)
                                    if (
                                        e.declarations[u] &&
                                        e.declarations[u].init &&
                                        c(e.declarations[u].init)
                                    ) {
                                        var f = {
                                                type: "VariableDeclaration",
                                                kind: e.kind,
                                                declarations: e.declarations.splice(
                                                    u
                                                )
                                            },
                                            d = r[0];
                                        if (!("index" in d))
                                            throw new Error(
                                                "VariableDeclaration not in a block"
                                            );
                                        d.parent[d.field].splice(
                                            d.index + 1,
                                            0,
                                            f
                                        );
                                        ...
                                        for (var o = 0; o < s.length; o++)
                                            if (
                                                ...
                                                for (
                                                    var u = 0;
                                                    u <
                                                    s[o].declarations.length;
                                                    u++
                                                )
                                                    te(
                                                        s[o].declarations[u].id
                                                    ).forEach(function(e) {
                                                        i[e] = s[o].kind;
                                                    });
                                    }
                                    t(),
                                        "AssignmentExpression" === e.type
                                            ...
                                            : "UpdateExpression" === e.type &&
                                              n(e.argument),
                                        s && (i = Object.getPrototypeOf(i));
                                });
                            })(e);
                        var p = !1;
                        return (
                            y.treeWalker(e, function(e, t, i) {
                                var s = p;
                                if (((p = p || oe(e)), a(e).isBlockStatement)) {
                                    if (c(e)) {
                                        var l, f, y, m, g;
                                        if (
                                            !i[0].parent ||
                                            a(i[0].parent).isScope
                                        ) {
                                            var x = {},
                                                w = {};
                                            (f = K(
                                                ...
                                                f.forEach(function(e) {
                                                    ...
                                                    n.append({
                                                        ...
                                                        expression: {
                                                            type:
                                                                "SequenceExpression",
                                                            expressions: e[0].self.declarations.map(
                                                                function(e) {
                                                                    var t = {
                                                                        type:
                                                ...
                                                (y = K(e, n(["var"]), !1)),
                                                (m = []);
                                        } else m = K(e, n(["const"]), !0);
                                        (m = m.concat(K(e, n(["let"]), !0))),
                                            (l = K(
                                                e,
                                                function(e) {
                                                    return a(e).isDirective;
                                                },
                                                !0
                                            )),
                                            (g = K(e, o, p)),
                                            ...
                                            (m = m
                                                ? ee(m, "let")
                                                : {duplicates: {}, decls: []}),
                                            Object.keys(y.duplicates).forEach(
                                                function(e) {
                                                    d(
                                                        v(y.duplicates[e]) +
                                            ...
                                            Object.keys(m.duplicates).forEach(
                                                function(e) {
                                                    d(
                                                        v(m.duplicates[e]) +
                                                            "Duplicate declaration '" +
                                ...
                                if (
                                    ...
                                    for (var E = 0, S = 0; S < i.length; S++)
                                        if (
                                            ...
                                            E += 1;
                                        else if (a(i[S].self).isFunction) break;
                                    (e.$depth = E),
                                        "LabeledStatement" === i[0].parent.type
                                            ? (e.$label = i[0].parent.label)
                                            : (e.$label = null);
                                }
                                return !0;
                            }),
                    ...
                    function re(e, t) {
                        return y.treeWalker(e, function(e, r, i) {
                            if (
                                (r(),
                                                                    ...
                                                                    r[0].parent
                                                                        ...
                                                                        ? "CallExpression" ===
                                                                          ...
                                                                          "callee" ===
                                                                              r[1]
                                                                                  .field
                                                                            ? ((i = y.part(
                                                                                  "this.$super($field).call(this,$args)",
                                                                                  {
                                                                                      super: n(),
                                                                                      field: r[0]
                                                                                          .parent
                                                                        ...
                                                                        : d(
                                                                              v(
                                                                                  ...
                                                                                  "'super' in async methods must be deferenced. 'async constructor()'/'await super()' not valid."
                                                                          )));
                                                        }
                                                    );
                                            };
                                ...
                                var s = y.part(
                                    "(function($field) { return super[$field] })",
                                    {field: h("$field")}
                                ).expr;
                                n.babelTree
                                    ? ((s.type = "ClassMethod"),
                    ...
                    function oe(e) {
                        if ("Program" === e.type && "module" === e.sourceType)
                            return !0;
                        var t;
                        if ("Program" === e.type) t = e.body;
                        else {
                            if (!a(e).isFunction) return !1;
                            t = e.body.body;
                        }
                        if (t)
                    ...
                    function ae(e) {
                        for (var t = 0; t < e.length; t++) {
                            ...
                            if (
                                ...
                                ("VariableDeclaration" === n.type &&
                                    ("let" === n.kind || "const" === n.kind)) ||
                    ...
                    function ue(e) {
                        y.treeWalker(e, function(e, t, n) {
                            if (
                                ...
                                "ArrowFunctionExpression" === e.type &&
                                    "BlockStatement" === e.body.type &&
                                    1 === e.body.body.length &&
                                    "ReturnStatement" === e.body.body[0].type)
                            )
                                e.body = e.body.body[0].argument;
                            else {
                                var r, i;
                                if ((r = a(e).isBlockStatement))
                                    for (var s = 0; s < r.length; s++)
                                        (i = a(r[s]).isBlockStatement) &&
                                            !ae(i) &&
                                            (ae(r[s]) ||
                                                [].splice.apply(
                                                    r,
                            ...
                            y.treeWalker(e, function(e, t, n) {
                                t(),
                                    e.$thisCall &&
                                        ...
                                        (ce[e.name].ref
                                            ? delete ce[e.name]
                                            : (ce[e.name].ref = e.$thisCall));
                            });
                        var t = Object.keys(ce).map(function(e) {
                            return ce[e].ref;
                        });
                        if (t.length) {
                            y.treeWalker(e, function(e, n, r) {
                                if (
                                    (n(),
                                    t.indexOf(e) >= 0 &&
                                        "ReturnStatement" === r[1].self.type)
                                ) {
                                    var s = e.$thisCallName,
                                        o = i(ce[s].def.body.body);
                                    (ce[s].$inlined = !0),
                                        a(r[1].self).isJump ||
                            ...
                            var n = Object.keys(ce).map(function(e) {
                                return ce[e].$inlined && ce[e].def;
                            });
                            y.treeWalker(e, function(e, t, r) {
                                t(), n.indexOf(e) >= 0 && r[0].remove();
                            });
                        }
                        if (
                            !(
                    ...
                    var he = y.part("var $0 = arguments", [pe.arguments])
                        .body[0];
                    return (
                        n.engine
                            ? ((e.ast = re(e.ast, !0)),
                              (e.ast = Z(e.ast, n.engine)),
                              (e.ast = se(e.ast)),
                              ue(e.ast))
                            : n.generators
                                ? ((e.ast = re(e.ast)),
                                  ...
                                  (e.ast = se(e.ast)),
                                  ue(e.ast))
                                : ((e.ast = re(e.ast)), A(e.ast)),
                        n.babelTree &&
                            y.treeWalker(e.ast, function(e, t, n) {
                                t(), "Literal" === e.type && s(e, b(e.value));
                            }),
                        e
                    );
                }
                var y = e("./parser"),
                    m = e("./output"),
                    g = {start: !0, end: !0, loc: !0, range: !0},
                    v = {
                        getScope: function() {
                            return "FunctionDeclaration" === this.node.type ||
                                "FunctionExpression" === this.node.type ||
                                "Function" === this.node.type ||
                                "ObjectMethod" === this.node.type ||
                                "ClassMethod" === this.node.type ||
                                ("ArrowFunctionExpression" === this.node.type &&
                                    "BlockStatement" === this.node.body.type)
                                ? this.node.body.body
                                : "Program" === this.node.type
                                    ? this.node.body
                                    : null;
                        },
                        isScope: function() {
                            return (
                                "FunctionDeclaration" === this.node.type ||
                                "FunctionExpression" === this.node.type ||
                                "Function" === this.node.type ||
                                "Program" === this.node.type ||
                                "ObjectMethod" === this.node.type ||
                        ...
                        isClass: function() {
                            return (
                                "ClassDeclaration" === this.node.type ||
                                "ClassExpression" === this.node.type
                            );
                        },
                        isBlockStatement: function() {
                            return "ClassBody" === this.node.type ||
                                "Program" === this.node.type ||
                                "BlockStatement" === this.node.type
                                ? this.node.body
                                : "SwitchCase" === this.node.type &&
                                      this.node.consequent;
                        },
                        isExpressionStatement: function() {
                            return "ExpressionStatement" === this.node.type;
                        },
                        isLiteral: function() {
                            return (
                                "Literal" === this.node.type ||
                                "BooleanLiteral" === this.node.type ||
                                "RegExpLiteral" === this.node.type ||
                                "NumericLiteral" === this.node.type ||
                                "StringLiteral" === this.node.type ||
                                "NullLiteral" === this.node.type
                            );
                        },
                        isDirective: function() {
                            return (
                                "ExpressionStatement" === this.node.type &&
                                ("StringLiteral" ===
                                    this.node.expression.type ||
                                    ("Literal" === this.node.expression.type &&
                                        "string" ==
                                            typeof this.node.expression.value))
                            );
                        },
                        isUnaryExpression: function() {
                            return "UnaryExpression" === this.node.type;
                        },
                        isAwait: function() {
                            return (
                                "AwaitExpression" === this.node.type &&
                                !this.node.$hidden
                            );
                        },
                        isAsync: function() {
                        ...
                        isStatement: function() {
                            return (
                                null !==
                                    this.node.type.match(
                                        /[a-zA-Z]+Declaration/
                                    ) ||
                                null !==
                                    this.node.type.match(/[a-zA-Z]+Statement/)
                            );
                        },
                        isExpression: function() {
                            return (
                                null !==
                                this.node.type.match(/[a-zA-Z]+Expression/)
                            );
                        },
                        isLoop: function() {
                            return (
                                "ForStatement" === this.node.type ||
                                "WhileStatement" === this.node.type ||
                                "DoWhileStatement" === this.node.type
                            );
                        },
                        isJump: function() {
                            return (
                                "ReturnStatement" === this.node.type ||
                                "ThrowStatement" === this.node.type ||
                                "BreakStatement" === this.node.type ||
                                "ContinueStatement" === this.node.type
                            );
                        },
                        isES6: function() {
                ...
                Object.keys(v).forEach(function(e) {
                    Object.defineProperty(b, e, {get: v[e]});
                }),
                    (t.exports = {
                        printNode: r,
                        babelLiteralNode: p,
                        asynchronize: function(e, t, n, r) {
                            try {
                                return d(e, 0, n, r);
                            } catch (t) {
                                if (t instanceof SyntaxError) {
                                    var i = e.origCode.substr(
                                        t.pos - t.loc.column
                                    );
                                    (i = i.split("\n")[0]),
                                        (t.message +=
            ...
            function(e, t, n) {
                ...
                function r(e) {
                    ...
                    var t =
                        h[e.type] ||
                        h[e.type + e.operator] ||
                        h[e.type + e.operator + (e.prefix ? "prefix" : "")];
                ...
                var i,
                    ...
                    u,
                    c,
                    l = e("source-map").SourceMapGenerator;
                if ("".repeat)
                    c = function(e, t) {
                        return t && e ? e.repeat(t) : "";
                    };
                else {
                    var p = {};
                    c = function(e, t) {
                ...
                var h = {
                    ...
                    d = {
                            ...
                            r
                                ...
                                : t.write(
                                      ...
                                      "/*" +
                                          e.type +
                                          "?*/ " +
                                          t.sourceAt(e.start, e.end)
                                  );
                        },
                        expr: function(e, t, n, i) {
                            2 === i ||
                            r(n) < r(t) ||
                            (r(n) == r(t) && (i || t.right === n))
                                ? (e.write(null, "("),
                        ...
                        formatParameters: function(e, t) {
                            var n;
                            if (
                                (t.write(null, "("), null != e && e.length > 0)
                            ) {
                                this.out(e[0], t, e[0].type);
                        ...
                        ParenthesizedExpression: function(e, t) {
                            this.expr(t, e, e.expression, 2);
                        },
                        ExpressionStatement: function(e, t) {
                            "FunctionExpression" === e.expression.type ||
                            "ObjectExpression" === e.expression.type
                                ? (t.write(null, "("),
                                  this.expr(t, e, e.expression),
                                  t.write(null, ")"))
                                : this.expr(t, e, e.expression),
                                t.write(null, ";");
                        },
                        IfStatement: function(e, t) {
                            t.write(e, "if ("),
                                this.out(e.test, t, e.test.type),
                                t.write(null, ") "),
                                "BlockStatement" !== e.consequent.type &&
                                    t.write(
                                        null,
                                        t.lineEnd,
                                        c(t.indent, t.indentLevel + 1)
                                    ),
                                this.out(e.consequent, t, e.consequent.type),
                                null != e.alternate &&
                                    ("BlockStatement" !== e.consequent.type &&
                                        t.write(
                                            null,
                                            t.lineEnd,
                                            c(t.indent, t.indentLevel)
                                        ),
                                    t.write(null, " else "),
                                    ...
                                    this.out(e.alternate, t, e.alternate.type));
                        },
                        LabeledStatement: function(e, t) {
                            this.out(e.label, t, e.label.type),
                                t.write(null, ":"),
                                this.out(e.body, t, e.body.type);
                        },
                        ...
                        WithStatement: function(e, t) {
                            t.write(e, "with ("),
                                this.out(e.object, t, e.object.type),
                                t.write(null, ") "),
                                this.out(e.body, t, e.body.type);
                        },
                        SwitchStatement: function(e, t) {
                            ...
                            t.write(e, "switch ("),
                                ...
                                t.write(null, ") {", o);
                            for (var l = e.cases, p = 0; p < l.length; p++) {
                                (n = l[p]).test
                                    ? (t.write(n, a, "case "),
                                      this.out(n.test, t, n.test.type),
                                      t.write(null, ":", o))
                                    : t.write(n, a, "default:", o),
                                    (r = n.consequent);
                            ...
                            (t.indentLevel -= 2), t.write(null, s, "}");
                        },
                        ReturnStatement: function(e, t) {
                            e.async && t.write(e, " async "),
                                t.write(e, "return"),
                                e.argument &&
                                    (t.write(null, " "),
                                    this.out(e.argument, t, e.argument.type)),
                                t.write(null, ";");
                        },
                        ...
                        TryStatement: function(e, t) {
                            t.write(e, "try "),
                                this.out(e.block, t, e.block.type),
                                e.handler &&
                                    this.out(e.handler, t, e.handler.type),
                                e.finalizer &&
                                    (t.write(e.finalizer, " finally "),
                                    this.out(e.finalizer, t, e.finalizer.type));
                        },
                        CatchClause: function(e, t) {
                            t.write(e, " catch ("),
                                this.out(e.param, t, e.param.type),
                                t.write(null, ") "),
                                this.out(e.body, t, e.body.type);
                        },
                        ...
                        ForStatement: function(e, t) {
                            ...
                            e.test && this.out(e.test, t, e.test.type),
                                t.write(null, "; "),
                                e.update &&
                                    this.out(e.update, t, e.update.type),
                                t.write(null, ") "),
                                "BlockStatement" !== e.body.type &&
                                    t.write(
                                        null,
                        ...
                        ForInStatement: (i = function(e, t) {
                            t.write(e, "for (");
                            var n = e.left,
                                r = n.type;
                            t.inForInit++,
                                this.out(n, t, r),
                                "V" === r[0] && 19 === r.length && t.back(),
                                t.inForInit--,
                                t.write(
                                    null,
                                    "I" === e.type[3] ? " in " : " of "
                                ),
                                this.out(e.right, t, e.right.type),
                                t.write(null, ") "),
                                "BlockStatement" !== e.body.type &&
                                    t.write(
                                        null,
                        ...
                        Function: function(e, t) {
                            e.async && t.write(e, "async "),
                                ...
                                e.id && t.write(e.id, e.id.name),
                                this.formatParameters(e.params, t),
                                this.out(e.body, t, e.body.type);
                        },
                        ...
                        VariableDeclaration: function(e, t) {
                            ...
                            var r = n.length;
                            if (r > 0) {
                                this.out(n[0], t, "VariableDeclarator");
                                for (var i = 1; i < r; i++)
                                    t.write(null, ", "),
                                        this.out(n[i], t, "VariableDeclarator");
                            }
                            t.write(null, ";");
                        },
                        VariableDeclarator: function(e, t) {
                            this.out(e.id, t, e.id.type),
                                null != e.init &&
                                    (t.write(null, " = "),
                                    this.expr(t, f, e.init));
                        },
                        ClassDeclaration: function(e, t) {
                            t.write(e, "class "),
                                e.id && t.write(e.id, e.id.name + " "),
                                e.superClass &&
                                    (t.write(null, "extends "),
                                    this.out(
                                        e.superClass,
                                        t,
                                        e.superClass.type
                                    ...
                                    t.write(null, " ")),
                                this.out(e.body, t, "BlockStatement");
                        },
                        ImportSpecifier: function(e, t) {
                            e.local.name == e.imported.name
                                ? this.out(e.local, t, e.local.type)
                                : (this.out(e.imported, t, e.imported.type),
                                  t.write(null, " as "),
                                  this.out(e.local, t, e.local.type));
                        },
                        ImportDefaultSpecifier: function(e, t) {
                            this.out(e.local, t, e.local.type);
                        },
                        ImportNamespaceSpecifier: function(e, t) {
                            t.write(null, "* as "),
                                this.out(e.local, t, e.local.type);
                        },
                        ImportDeclaration: function(e, t) {
                            ...
                            if (r > 0) {
                                for (var s = 0; s < r; s++)
                                    "ImportSpecifier" === n[s].type &&
                                        i &&
                                        ((i = !1), t.write(null, "{")),
                                        this.out(n[s], t, n[s].type),
                                        s < r - 1 && t.write(null, ", ");
                                "ImportSpecifier" === n[r - 1].type &&
                                    t.write(null, "}"),
                                    t.write(null, " from ");
                            }
                            t.write(e.source, e.source.raw), t.write(null, ";");
                        },
                        ExportDefaultDeclaration: function(e, t) {
                            t.write(e, "export default "),
                                this.out(e.declaration, t, e.declaration.type);
                        },
                        ExportSpecifier: function(e, t) {
                            e.local.name == e.exported.name
                                ...
                                : (this.out(e.local, t, e.local.type),
                                  t.write(null, " as "),
                                  this.out(e.exported, t, e.exported.type));
                        },
                        ExportNamedDeclaration: function(e, t) {
                            if ((t.write(e, "export "), e.declaration))
                                this.out(e.declaration, t, e.declaration.type);
                            else {
                                var n = e.specifiers;
                                if ((t.write(e, "{"), n && n.length > 0))
                                    for (var r = 0; r < n.length; r++)
                                        this.out(n[r], t, n[r].type),
                                            r < n.length - 1 &&
                                                t.write(null, ", ");
                                t.write(null, "}"),
                                    e.source &&
                        ...
                        ExportAllDeclaration: function(e, t) {
                            t.write(e, "export * from "),
                                t.write(e.source, e.source.raw, ";");
                        },
                        MethodDefinition: function(e, t) {
                            switch (
                                (e.value.async && t.write(e, "async "),
                                e.static && t.write(e, "static "),
                                e.kind)
                            ) {
                                case "get":
                                case "set":
                            ...
                            e.value.generator && t.write(null, "*"),
                                e.computed
                                    ? (t.write(null, "["),
                                      this.out(e.key, t, e.key.type),
                                      t.write(null, "]"))
                                    : this.out(e.key, t, e.key.type),
                                this.formatParameters(e.value.params, t),
                                this.out(e.value.body, t, e.value.body.type);
                        },
                        ClassMethod: function(e, t) {
                            switch (
                                (e.async && t.write(e, "async "),
                                e.static && t.write(e, "static "),
                                e.kind)
                        ...
                        ArrowFunctionExpression: function(e, t) {
                            e.async && t.write(e, "async "),
                                ...
                                "SequenceExpression" === e.body.type
                                    ? (t.write(null, "("),
                                      this.out(e.body, t, e.body.type),
                                      t.write(null, ")"))
                                    : this.out(e.body, t, e.body.type);
                        ...
                        RestElement: (s = function(e, t) {
                            t.write(e, "..."),
                                this.out(e.argument, t, e.argument.type);
                        }),
                        SpreadElement: s,
                        YieldExpression: function(e, t) {
                            t.write(e, e.delegate ? "yield*" : "yield"),
                                e.argument &&
                                    (t.write(null, " "),
                                    this.expr(t, e, e.argument));
                        },
                        AwaitExpression: function(e, t) {
                            t.write(e, "await "), this.expr(t, e, e.argument);
                        },
                        TemplateLiteral: function(e, t) {
                            ...
                            for (var s = 0, o = i.length; s < o; s++)
                                (n = i[s]),
                                    t.write(r[s].value, r[s].value.raw),
                                    t.write(null, "${"),
                                    this.out(n, t, n.type),
                                    t.write(null, "}");
                            t.write(
                                r[r.length - 1].value,
                                r[r.length - 1].value.raw
                            ),
                                t.write(e, "`");
                        },
                        TaggedTemplateExpression: function(e, t) {
                            this.out(e.tag, t, e.tag.type),
                                this.out(e.quasi, t, e.quasi.type);
                        },
                        ArrayExpression: (a = function(e, t) {
                            if ((t.write(e, "["), e.elements.length > 0))
                                for (
                                    var n = e.elements, r = n.length, i = 0;
                                    ;
                        ...
                        ObjectExpression: function(e, t) {
                            var n,
                                r = c(t.indent, t.indentLevel++),
                                i = t.lineEnd,
                                s = r + t.indent;
                            if ((t.write(e, "{"), e.properties.length > 0)) {
                                t.write(null, i);
                                for (
                                    var o = e.properties, a = o.length, u = 0;
                                    (n = o[u]),
                                        t.write(null, s),
                                        this.out(n, t, "Property"),
                                        ++u < a;
                            ...
                            e.method || "get" === e.kind || "set" === e.kind
                                ...
                                : (e.shorthand ||
                                      (e.computed
                                          ...
                                          : this.out(e.key, t, e.key.type),
                                      t.write(null, ": ")),
                                  this.expr(t, f, e.value));
                        },
                        ObjectPattern: function(e, t) {
                            if ((t.write(e, "{"), e.properties.length > 0))
                                for (
                                    var n = e.properties, r = n.length, i = 0;
                                    this.out(n[i], t, "Property"), ++i < r;
                        ...
                        UnaryExpression: function(e, t) {
                            e.prefix
                                ? (t.write(e, e.operator),
                                  e.operator.length > 1 && t.write(e, " "),
                                  this.expr(t, e, e.argument, !0))
                                : (this.expr(t, e, e.argument),
                                  t.write(e, e.operator));
                        },
                        ...
                        BinaryExpression: (o = function(e, t) {
                            var n = e.operator;
                            "in" === n && t.inForInit && t.write(null, "("),
                                this.expr(t, e, e.left),
                                t.write(e, " ", n, " "),
                                this.expr(
                                    t,
                                    e,
                                    e.right,
                                    "ArrowFunctionExpression" === e.right.type
                                        ? 2
                                        : 0
                                ),
                                "in" === n && t.inForInit && t.write(null, ")");
                        ...
                        AssignmentExpression: function(e, t) {
                            "ObjectPattern" === e.left.type &&
                                t.write(null, "("),
                                this.BinaryExpression(e, t),
                                "ObjectPattern" === e.left.type &&
                                    t.write(null, ")");
                        },
                        AssignmentPattern: function(e, t) {
                            this.expr(t, e, e.left),
                                t.write(e, " = "),
                                this.expr(t, e, e.right);
                        },
                        ConditionalExpression: function(e, t) {
                            this.expr(t, e, e.test, !0),
                                t.write(e, " ? "),
                                this.expr(t, e, e.consequent),
                                t.write(null, " : "),
                                this.expr(t, e, e.alternate);
                        },
                        NewExpression: function(e, t) {
                            t.write(e, "new "),
                                this.expr(
                                    ...
                                    "ObjectExpression" === e.callee.type
                                        ? 2
                                        : 0
                                ),
                                this.argumentList(e, t);
                        },
                        CallExpression: function(e, t) {
                            this.expr(
                                ...
                                e,
                                e.callee,
                                "ObjectExpression" === e.callee.type ? 2 : 0
                            ),
                                this.argumentList(e, t);
                        },
                        MemberExpression: function(e, t) {
                            !(
                                "ObjectExpression" === e.object.type ||
                                (e.object.type.match(/Literal$/) &&
                                    e.object.raw &&
                                    e.object.raw.match(/^[0-9]/))
                            ) &&
                            ("ArrayExpression" === e.object.type ||
                                "CallExpression" === e.object.type ||
                                "NewExpression" === e.object.type ||
                                r(e) <= r(e.object))
                                ? this.out(e.object, t, e.object.type)
                                : (t.write(null, "("),
                                  this.out(e.object, t, e.object.type),
                                ...
                                e.computed
                                    ? (t.write(e, "["),
                                      this.out(e.property, t, e.property.type),
                                      t.write(null, "]"))
                                    : (t.write(e, "."),
                                      this.out(e.property, t, e.property.type));
                        },
                        ...
                        NullLiteral: function(e, t) {
                            t.write(e, "null");
                        },
                        BooleanLiteral: function(e, t) {
                            t.write(e, JSON.stringify(e.value));
                        },
                        ...
                        RegExpLiteral: function(e, t) {
                            t.write(
                                e,
                                e.extra.raw || "/" + e.pattern + "/" + e.flags
                            );
                        },
                        NumericLiteral: function(e, t) {
                            t.write(e, JSON.stringify(e.value));
                        }
                    };
                t.exports = function(e, t, n) {
                    var r = "",
                        i = [],
                        s = (t = t || {}).map && new l(t.map);
                    s &&
                        t.map.sourceContent &&
                        s.setSourceContent(t.map.file, t.map.sourceContent);
                    var o = "",
                        a = [],
                        u = [],
                        p = {
                            ...
                            sourceAt: function(e, t) {
                                return n
                                    ? n.substring(e, t)
                                    : "/* Omitted Non-standard node */";
                            },
                            write: function(e) {
                                ...
                                for (var n = 1; n < arguments.length; n++)
                                    if (
                                        ...
                                        (r += arguments[n]),
                                            e &&
                                                e.$comments &&
                                                (e.$comments.forEach(function(
                                                    t
                                                ) {
                                                    var n =
                                                        e.loc.start.column <
                                                        t.loc.start.column;
                                                    (t.indent = p.indentLevel),
                                                        n
                                                            ? u.push(t)
                                                            : a.push(t);
                                                }),
                            ...
                            back: function() {
                                r = r.substring(0, r.length - o.length);
                            },
                            indent: "    ",
                            lineEnd: "\n",
                            indentLevel: 0,
                    ...
                    d.out(e, p), (u = e.$comments || []), p.write(e, p.lineEnd);
                    var h = i.join(p.lineEnd);
                    return t && t.map ? {code: h, map: s} : h;
                };
            },
            {"source-map": 24}
        ],
        13: [
            function(e, t, n) {
                "use strict";
                function r(e, t) {
                    ["start", "end", "loc", "range"].forEach(function(n) {
                ...
                function i(e, t, n) {
                        ...
                        (e.replace = u.replace),
                            ...
                            e.index
                                ? (Object.defineProperties(e, {
                                      index: {enumerable: !0, get: u.index}
                                  }),
                                  (e.remove = u.removeElement))
                                : (e.remove = u.removeNode),
                            n.unshift(e),
                            i(e.self, t, n),
                            n.shift();
                    }
                    return (
                        ...
                        t(
                            ...
                            function() {
                                e.type in a &&
                                    a[e.type](e, n, function t(i, s, o) {
                                        if (i === e)
                                            return a[o || e.type](e, n, t);
                                        for (
                ...
                function s(t, n) {
                    ...
                    if (
                        ((!n ||
                            !n.noNodentExtensions ||
                            parseInt(o.version) < 4) &&
                            (c ||
                                (parseInt(o.version) < 4 &&
                                    console.warn(
                                        "Nodent: Warning - noNodentExtensions option requires acorn >=v4.x. Extensions installed."
                                    ),
                                e("acorn-es7-plugin")(o),
                                (c = !0)),
                            (s.plugins = s.plugins || {}),
                            (s.plugins.asyncawait = {
                                asyncExits: !0,
                                awaitAnywhere: !0
                            })),
                        n)
                    ...
                    return (
                        i(u, function(e, t, n) {
                            for (
                                ...
                                r.length &&
                                e.loc &&
                                e.loc.start.line >= r[0].loc.start.line &&
                                e.loc.end.line >= r[0].loc.end.line;

                            )
                                (e.$comments = e.$comments || []),
                                    e.$comments.push(r.shift());
                        }),
                        u
                    );
                }
                var o = e("acorn"),
                    a = e("acorn/dist/walk").make({
                        AwaitExpression: function(e, t, n) {
                            n(e.argument, t, "Expression");
                        },
                        SwitchStatement: function(e, t, n) {
                            n(e.discriminant, t, "Expression");
                            for (var r = 0; r < e.cases.length; ++r)
                                n(e.cases[r], t);
                        },
                        SwitchCase: function(e, t, n) {
                            e.test && n(e.test, t, "Expression");
                            for (var r = 0; r < e.consequent.length; ++r)
                                n(e.consequent[r], t, "Statement");
                        },
                        TryStatement: function(e, t, n) {
                            n(e.block, t, "Statement"),
                                e.handler && n(e.handler, t, "Statement"),
                                e.finalizer && n(e.finalizer, t, "Statement");
                        },
                        CatchClause: function(e, t, n) {
                            n(e.param, t, "Pattern"), n(e.body, t, "ScopeBody");
                        },
                        ...
                        ClassProperty: function(e, t, n) {
                            e.key && n(e.key, t, "Expression"),
                                e.value && n(e.value, t, "Expression");
                        },
                        ClassMethod: function(e, t, n) {
                            e.key && n(e.key, t, "Expression"),
                                n(e, t, "Function");
                        },
                        ObjectProperty: function(e, t, n) {
                            e.key && n(e.key, t, "Expression"),
                                e.value && n(e.value, t, "Expression");
                        },
                        ObjectMethod: function(e, t, n) {
                            e.key && n(e.key, t, "Expression"),
                                n(e, t, "Function");
                        }
                    }),
                    u = {
                                    ...
                                    ? (r(
                                      ...
                                      Array.isArray(e)
                                          ? [].splice.apply(
                                                ...
                                                [this.index, 1].concat(e)
                                            )
                                          : (this.parent[this.field][
                                                this.index
                                            ] = e))
                                    : (r(this.parent[this.field], e),
                                      Array.isArray(e)
                                          ? (this.parent[this.field] = {
                                                type: "BlockStatement",
                                                body: e
                                            })
                                          : (this.parent[this.field] = e)),
                                this.self
                            );
                        },
                        append: function(e) {
                            ...
                            return (
                                Array.isArray(e)
                                    ? [].splice.apply(
                                          this.parent[this.field],
                                          [this.index + 1, 0].concat(e)
                                      )
                                    : this.parent[this.field].splice(
                                          this.index + 1,
                                          0,
                                          e
                                      ),
                        ...
                        removeElement: function() {
                            return this.parent[this.field].splice(
                                this.index,
                                1
                            )[0];
                        },
                        removeNode: function() {
                            var e = this.parent[this.field];
                            return delete this.parent[this.field], e;
                        }
                    },
                    c = !1,
                    l = {};
                    ...
                    part: function(e, t) {
                        function n(e, r) {
                            if (Array.isArray(r) && !Array.isArray(e))
                                throw new Error(
                                    "Can't substitute an array for a node"
                                );
                            return (
                                (r = r || {}),
                                Object.keys(e).forEach(function(i) {
                                    ...
                                    if (
                                        ...
                                        return s(t[e[i].name.slice(1)]);
                                    if (
                                        "LabeledStatement" === e[i].type &&
                                        "$" === e[i].label.name
                                    ) {
                                        var o = e[i].body.expression;
                                        return s(t[o.name || o.value]);
                                    }
                                    return "LabeledStatement" === e[i].type &&
                                        "$$" === e[i].label.name.slice(0, 2)
                                        ? s(
                                              t[e[i].label.name.slice(2)](
                                                  n(e[i]).body
                                              )
                                          )
                                        : s(n(e[i]));
            ...
            {acorn: 4, "acorn-es7-plugin": 1, "acorn/dist/walk": 5}
        ],
        14: [
            function(e, t, n) {
                function r() {
                ...
                (r.prototype.unsortedForEach = function(e, t) {
                    ...
                    (r.prototype.add = function(e) {
                        !(function(e, t) {
                            ...
                            return (
                                r > n ||
                                (r == n && o >= s) ||
                                i.compareByGeneratedPositionsInflated(e, t) <= 0
                            );
                        })(this._last, e)
                    ...
                    (r.prototype.toArray = function() {
                        return (
                            this._sorted ||
                                (this._array.sort(
                                    i.compareByGeneratedPositionsInflated
                                ),
                                (this._sorted = !0)),
                            this._array
                        );
            ...
            function(e, t, n) {
                ...
                function i(e, t, n, s) {
                    if (n < s) {
                        ...
                        for (var a = e[s], u = n; u < s; u++)
                            t(e[u], a) <= 0 && r(e, (o += 1), u);
                        r(e, o + 1, u);
                        var c = o + 1;
                        i(e, t, n, c - 1), i(e, t, c + 1, s);
                    }
                }
            ...
            function(e, t, n) {
                function r(e) {
                    ...
                    return (
                        ...
                        null != t.sections ? new o(t) : new i(t)
                    );
                }
                function i(e) {
                    var t = e;
                    "string" == typeof e &&
                        (t = JSON.parse(e.replace(/^\)\]\}'/, "")));
                    var n = a.getArg(t, "version"),
                        r = a.getArg(t, "sources"),
                        i = a.getArg(t, "names", []),
                        s = a.getArg(t, "sourceRoot", null),
                ...
                (r.fromSourceMap = function(e) {
                    ...
                    ((i.prototype = Object.create(r.prototype)).consumer = r),
                    (i.fromSourceMap = function(e) {
                        var t = Object.create(i.prototype),
                            n = (t._names = c.fromArray(
                                e._names.toArray(),
                                !0
                            )),
                            r = (t._sources = c.fromArray(
                                e._sources.toArray(),
                                !0
                            ));
                        ...
                        for (
                            ...
                            var d = o[h],
                                y = new s();
                            (y.generatedLine = d.generatedLine),
                                (y.generatedColumn = d.generatedColumn),
                                d.source &&
                                    ((y.source = r.indexOf(d.source)),
                                    (y.originalLine = d.originalLine),
                                    (y.originalColumn = d.originalColumn),
                                    d.name && (y.name = n.indexOf(d.name)),
                                    l.push(y)),
                                u.push(y);
                        }
                        return (
                            p(
                                t.__originalMappings,
                                a.compareByOriginalPositions
                            ),
                            t
                        );
                    ...
                    (i.prototype._parseMappings = function(e, t) {
                        for (
                            ...
                            if (";" === e.charAt(v)) c++, v++, (h = 0);
                            else if ("," === e.charAt(v)) v++;
                            else {
                                for (
                                    (n = new s()).generatedLine = c, o = v;
                                    o < g &&
                                    !this._charIsMappingSeparator(e, o);
                                    o++
                                );
                                if (((r = e.slice(v, o)), (i = b[r])))
                                    v += r.length;
                                else {
                                    for (i = []; v < o; )
                                        l.decode(e, v, x),
                    ...
                    (i.prototype.sourceContentFor = function(e, t) {
                        ...
                        if (
                            (null != this.sourceRoot &&
                                (e = a.relative(this.sourceRoot, e)),
                            this._sources.has(e))
                        )
                    ...
                    (i.prototype.generatedPositionFor = function(e) {
                        ...
                        if (
                            (null != this.sourceRoot &&
                                (t = a.relative(this.sourceRoot, t)),
                            !this._sources.has(t))
                        )
                        ...
                        get: function() {
                            for (
                                ...
                                for (
                                    var n = 0;
                                    n <
                                    this._sections[t].consumer.sources.length;
                                    n++
                                )
                                    e.push(
                                        this._sections[t].consumer.sources[n]
                                    );
                            return e;
                        }
                    }),
                        ...
                        var t = {
                            ...
                            n = u.search(t, this._sections, function(e, t) {
                                ...
                                return (
                                    n ||
                                    e.generatedColumn -
                                        t.generatedOffset.generatedColumn
                                );
                            }),
                            r = this._sections[n];
                        return r
                        ...
                        for (var n = 0; n < this._sections.length; n++)
                            for (
                                var r = this._sections[n],
                                    i = r.consumer._generatedMappings,
                                    s = 0;
                                s < i.length;
                                s++
                            ) {
                                ...
                                null !== r.consumer.sourceRoot &&
                                    (u = a.join(r.consumer.sourceRoot, u)),
                                    this._sources.add(u),
        ...
        21: [
            function(e, t, n) {
                ...
                (r.prototype._version = 3),
                    (r.fromSourceMap = function(e) {
                        var t = e.sourceRoot,
                            n = new r({file: e.file, sourceRoot: t});
                        return (
                            e.eachMapping(function(e) {
                                ...
                                null != e.source &&
                                    ((r.source = e.source),
                                    null != t &&
                                        (r.source = s.relative(t, r.source)),
                                    (r.original = {
                                        line: e.originalLine,
                        ...
                        null != this._sourceRoot &&
                            ...
                            null != t
                                ? (this._sourcesContents ||
                                      (this._sourcesContents = Object.create(
                                          null
                                      )),
                                  (this._sourcesContents[s.toSetString(n)] = t))
                                : this._sourcesContents &&
                    ...
                    (r.prototype._serializeMappings = function() {
                        for (
                            ...
                            if (((t = f[d]), (e = ""), t.generatedLine !== a))
                                for (o = 0; t.generatedLine !== a; )
                                    (e += ";"), a++;
                            else if (d > 0) {
                                if (
                                    !s.compareByGeneratedPositionsInflated(
                                        t,
                                        f[d - 1]
                                    )
                                )
        ...
        22: [
                ...
                (r.fromStringWithSourceMap = function(e, t, n) {
                    ...
                    return (
                        t.eachMapping(function(e) {
                            ...
                            for (; p < e.generatedLine; ) a.add(l()), p++;
                            if (h < e.generatedColumn) {
                                var n = u[c];
                                a.add(n.substr(0, e.generatedColumn)),
                                    (u[c] = n.substr(e.generatedColumn)),
                                    (h = e.generatedColumn);
                            }
                            f = e;
                        }, this),
                        c < u.length &&
                            (f && i(f, l()), a.add(u.splice(c).join(""))),
            ...
            {"./source-map-generator": 21, "./util": 23}
        ],
        23: [
            function(e, t, n) {
                function r(e) {
                ...
                (n.urlParse = r),
                    ...
                    (n.join = function(e, t) {
                        ...
                        if ((o && (e = o.path || "/"), n && !n.scheme))
                            return o && (n.scheme = o.scheme), i(n);
                        if (n || t.match(l)) return t;
                        if (o && !o.host && !o.path) return (o.host = t), i(o);
                        var a =
                            "/" === t.charAt(0)
                                ? t
                                : s(e.replace(/\/+$/, "") + "/" + t);
                        return o ? ((o.path = a), i(o)) : a;
                    }),
                    (n.isAbsolute = function(e) {
                        return "/" === e.charAt(0) || !!e.match(c);
                    }),
                    (n.relative = function(e, t) {
                        ...
                        return (
                            Array(n + 1).join("../") + t.substr(e.length + 1)
                        );
                    });
                        ...
                        return 0 !== r
                            ...
                            : 0 != (r = e.originalLine - t.originalLine)
                                ...
                                : 0 !=
                                    ...
                                    : 0 !=
                                      (r =
                                          e.generatedColumn - t.generatedColumn)
                                        ? r
                                        : 0 !=
                                          (r =
                                              e.generatedLine - t.generatedLine)
                                            ? r
                                            : e.name - t.name;
                    }),
        ...
        24: [
            function(e, t, n) {
                (n.SourceMapGenerator = e(
                    "./lib/source-map-generator"
                ).SourceMapGenerator),
                    (n.SourceMapConsumer = e(
                        "./lib/source-map-consumer"
                    ).SourceMapConsumer),
                    (n.SourceNode = e("./lib/source-node").SourceNode);
            },
            {
                "./lib/source-map-consumer": 20,
                "./lib/source-map-generator": 21,
                "./lib/source-node": 22
            }
        ],
        25: [
                ...
                t.exports = {
                    _args: [
                        [
                            ...
                            "/Users/evgenypoberezkin/Documents/JSON/ajv/node_modules/nodent"
                        ]
                    ],
                    ...
                    _npmOperationalInternal: {
                        ...
                        tmp:
                            "tmp/nodent-compiler-3.1.5.tgz_1511792299537_0.15715787676163018"
                    },
                    _npmUser: {name: "matatbread", email: "npm@mailed.me.uk"},
                    _npmVersion: "5.5.1",
                    _phantomChildren: {},
                    _requested: {
                        raw: "nodent-compiler@>=3.1.5",
                    ...
                    _requiredBy: ["/nodent"],
                    _resolved:
                        "https://registry.npmjs.org/nodent-compiler/-/nodent-compiler-3.1.5.tgz",
                    ...
                    bugs: {url: "https://github.com/MatAtBread/nodent/issues"},
                    dependencies: {
                        acorn: ">=2.5.2",
                    ...
                    dist: {
                        integrity:
                            "sha512-Istg796un2lALiy/eFNnLbAEMovQqrtpVqXVY8PKs6ycsyBbK480D55misJBQ1QxvstcJ7Hk9xbSVkV8lIi+tg==",
                        shasum: "8c09289eacf7256bda89c2b88941681d5cccf80c",
                        tarball:
                            "https://registry.npmjs.org/nodent-compiler/-/nodent-compiler-3.1.5.tgz"
                    },
                    engines: "node >= 0.10.0",
                    gitHead: "93054f019902e2b107e7be681836273f35a02614",
                    homepage:
                        "https://github.com/MatAtBread/nodent-compiler#readme",
                    keywords: [
                        "Javascript",
                        "ES7",
                        "async",
                    ...
                    main: "compiler.js",
                    maintainers: [
                        {name: "matatbread", email: "npm@mailed.me.uk"}
                    ],
                    name: "nodent-compiler",
                    ...
                    repository: {
                        type: "git",
                        url:
                            "git+https://github.com/MatAtBread/nodent-compiler.git"
                    },
                    scripts: {
                        test:
                            "node tests/basic.js # Please install 'nodent' and test the compiler fully from there."
                    },
                    version: "3.1.5"
                };
            },
        ...
        26: [
            function(e, t, n) {
                ...
                var i = (function(e, t) {
                    ...
                    {
                        zousan: e("./zousan").toString(),
                        thenable: e("./thenableFactory").toString()
                    },
                    function e(t, n) {
                        function r() {
                        ...
                        Function.prototype.$asyncbind ||
                            ...
                            e.LazyThenable ||
                                ((e.LazyThenable = "!!!thenable"()),
                                (e.EagerThenable = e.Thenable = (e.EagerThenableFactory =
                                    "!!!zousan")()));
                        var i = this;
                        switch (n) {
                            case !0:
                ...
                i(), r(), (t.exports = {$asyncbind: i, $asyncspawn: r});
            },
            {"./thenableFactory": 27, "./zousan": 28}
        ],
        27: [
            function(e, t, n) {
                t.exports = function() {
        ...
        30: [
            function(e, t, n) {
                (function(e) {
                    ...
                    (n.resolve = function() {
                        for (
                            var n = "", i = !1, s = arguments.length - 1;
                            s >= -1 && !i;
                            s--
                        ) {
            ...
            function(e, t, n) {
                (function(e) {
                    ...
                    (a.parse = function(e) {
                        ...
                        (t.exports = n ? s.parse : a.parse),
                        (t.exports.posix = a.parse),
                        (t.exports.win32 = s.parse);
                }.call(this, e("_process")));
            },
            {_process: 32}
        ],
        ...
        33: [
            ...
            {"./lib/async": 34, "./lib/core": 37, "./lib/sync": 39}
        ],
        34: [
            function(e, t, n) {
                (function(n) {
                    ...
                    t.exports = function(e, t, u) {
                        ...
                        function l(e, t, n) {
                            function r(e, t, n) {
                                function i(n, i, l) {
                                    if (((c = i), n)) return o(n);
                                    if (l && c && y.pathFilter) {
                                        var p = s.relative(l, u),
                                            h = p.slice(
                                                0,
                                                p.length - e[0].length
                                            ),
                                            f = y.pathFilter(c, t, h);
                                        if (f)
                                            return r(
                                                [""].concat(b.slice()),
                                                s.resolve(l, f),
                                ...
                                function a(n, i) {
                                    return n
                                        ...
                                        : i
                                            ? o(null, u, c)
                                            : void r(e.slice(1), t, c);
                                }
                                if (0 === e.length) return o(null, void 0, n);
                                var u = t + e[0],
                                    c = n;
                                c ? i(null, c) : p(s.dirname(u), i);
                            }
                            var i = t,
                                o = n;
                        ...
                        function p(e, t) {
                            if ("" === e || "/" === e) return t(null);
                            if ("win32" === n.platform && /^\w:[/\\]*$/.test(e))
                                return t(null);
                            if (/[/\\]node_modules[/\\]*$/.test(e))
                                return t(null);
                            var r = s.join(e, "package.json");
                            g(r, function(n, i) {
                                if (!i) return p(s.dirname(e), t);
                                v(r, function(n, i) {
                                    n && t(n);
                                    try {
                                        var s = JSON.parse(i);
                        ...
                        function h(e, t, n) {
                            ...
                            "function" == typeof i &&
                                ((r = i), (i = y.package));
                            var o = s.join(e, "package.json");
                            g(o, function(t, n) {
                                return t
                                    ? r(t)
                                    : n
                                        ? void v(o, function(t, n) {
                                              if (t) return r(t);
                                              try {
                                                  var i = JSON.parse(n);
                                              } catch (e) {}
                        ...
                        function f(t, n) {
                            ...
                            var i = n[0];
                            l(s.join(i, e), void 0, function(n, o, a) {
                                return n
                                    ? t(n)
                                    : o
                                        ? t(null, o, a)
                                        : void h(s.join(i, e), void 0, r);
                            });
                        }
                        var d = u,
                            y = t || {};
                        if (
                            ("function" == typeof y && ((d = y), (y = {})),
                            "string" != typeof e)
                        ) {
                            var m = new TypeError("Path must be a string.");
                        ...
                        var g =
                            ...
                            v = y.readFile || i.readFile,
                            b = y.extensions || [".js"],
                            x = y.basedir || s.dirname(o());
                        if (
                            ((y.paths = y.paths || []),
                            /^(?:\.\.?(?:\/|$)|\/|([A-Za-z]:)?[/\\])/.test(e))
                        ) {
                            ...
                            !(function(e, t, n) {
                                ...
                                if (t) d(t);
                                else if (n) d(null, n, i);
                                else {
                                    if (r[e]) return d(null, e);
                                    var s = new Error(
                                        "Cannot find module '" +
                                            e +
                                            "' from '" +
        ...
        37: [
            ...
            {"./core.json": 36, _process: 32}
        ],
        38: [
            function(e, t, n) {
                var r = e("path"),
                    i = e("fs"),
                    s = r.parse || e("path-parse");
                t.exports = function(e, t) {
                    var n =
                            t && t.moduleDirectory
                    ...
                    /^([A-Za-z]:)/.test(o)
                        ? (a = "")
                        : /^\\\\/.test(o) && (a = "\\\\");
                    for (var u = [o], c = s(o); c.dir !== u[u.length - 1]; )
                        u.push(c.dir), (c = s(c.dir));
                    ...
                    return t && t.paths ? l.concat(t.paths) : l;
                };
            },
            {fs: 7, path: 30, "path-parse": 31}
        ],
        39: [
            function(e, t, n) {
                var r = e("./core"),
                ...
                t.exports = function(e, t) {
                    ...
                    function u(e) {
                        ...
                        if (l(t))
                            try {
                                ...
                                if (
                                    (c.packageFilter &&
                                        (i = c.packageFilter(i, e)),
                                    i.main)
                                ) {
                                    ("." !== i.main && "./" !== i.main) ||
                                        (i.main = "index");
                                    var o = n(s.resolve(e, i.main));
                                    if (o) return o;
                                    var a = u(s.resolve(e, i.main));
                                    if (a) return a;
                                }
                            } catch (e) {}
                        return n(s.join(e, "/index"));
                    }
                    if ("string" != typeof e)
                    ...
                    var c = t || {},
                        ...
                        p = c.readFileSync || i.readFileSync,
                        h = c.extensions || [".js"],
                        f = c.basedir || s.dirname(o());
                    if (
                        ((c.paths = c.paths || []),
                        /^(?:\.\.?(?:\/|$)|\/|([A-Za-z]:)?[/\\])/.test(e))
                    ) {
                        ...
                        var m = (function(e, t) {
                            for (var r = a(t, c), i = 0; i < r.length; i++) {
                                var o = r[i],
                                    l = n(s.join(o, "/", e));
                                if (l) return l;
                                var p = u(s.join(o, "/", e));
                ...
                (function(process, global, __dirname) {
                    ...
                    function parseCompilerOptions(code, log, filename) {
                        ...
                        if ("string" == typeof code)
                            (regex = code.match(useDirective)) &&
                                (set = regex[1] || "default");
                        else
                            for (
                                var i = 0;
                                i < code.body.length &&
                                isDirective(code.body[i].type);
                                i++
                            ) {
                        ...
                        if (!regex) {
                            if (!defaultCodeGenOpts.noUseDirective) return null;
                            (set = "default"), (regex = [null, null, "{}"]);
                        }
                        if (set)
                            try {
                                filename
                                    ? require("fs")
                                          .lstatSync(filename)
                                          .isDirectory() ||
                                      (filename = require("path").dirname(
                                          filename
                                      ))
                                    : (filename = require("path").resolve("."));
                                var packagePath = require("resolve").sync(
                                        "package.json",
                                        {
                                            moduleDirectory: [""],
                                            extensions: [""],
                                    ...
                                    packageOptions = JSON.parse(
                                        fs.readFileSync(packagePath)
                                    ).nodent.directive[set];
                            } catch (e) {}
                        try {
                            parseOpts = copyObj([
                                optionSets[set],
                                packageOptions,
                                regex[2] && JSON.parse(regex[2])
                            ]);
                        } catch (e) {
                            log(
                                "Invalid literal compiler option: " +
                                    ((regex && regex[0]) ||
                                        "<no options found>")
                            );
                        }
                        return (
                            Object.keys(hostOptions).forEach(function(k) {
                                "host" === parseOpts[k] &&
                                    (parseOpts[k] = (function() {
                                        try {
                                            return eval(hostOptions[k]), !0;
                                        } catch (e) {
                                            return !1;
                                        }
                                    })());
                            ...
                            parseOpts.promises ||
                            parseOpts.es7 ||
                            parseOpts.generators ||
                            parseOpts.engine
                                ? ((parseOpts.promises || parseOpts.es7) &&
                                      parseOpts.generators &&
                                      (log(
                                          "No valid 'use nodent' directive, assumed -es7 mode"
                                      ),
                                      (parseOpts = optionSets.es7)),
                                  (parseOpts.generators || parseOpts.engine) &&
                                      (parseOpts.promises = !0),
                                  parseOpts.promises && (parseOpts.es7 = !0),
                                  parseOpts)
                                : null
                        );
                    }
                    ...
                    function compileNodentedFile(e, t) {
                        return (
                            (t = t || e.log),
                            function(n, r, i) {
                                var s = stripBOM(fs.readFileSync(r, "utf8")),
                                    o = e.parse(s, r, i);
                                (i = i || parseCompilerOptions(o.ast, t, r)),
                                    e.asynchronize(o, void 0, i, t),
                                    e.prettyPrint(o, i),
                                    n._compile(o.code, o.filename);
                            }
                        );
                    }
                    function asyncify(e) {
                    ...
                    function generateRequestHandler(e, t, n) {
                        var r = {},
                            i = this;
                        t || (t = /\.njs$/),
                            n
                                ? n.compiler || (n.compiler = {})
                                : (n = {compiler: {}});
                        var s = copyObj([
                        ...
                        return function(o, a, u) {
                            ...
                            if (r[o.url])
                                return (
                                    ...
                                    n.setHeaders && n.setHeaders(a),
                                    a.write(r[o.url].output),
                                    void a.end()
                                );
                            if (
                                !(
                                ...
                                return u && u();
                            var l = e + o.url;
                            if (n.extensions && !fs.existsSync(l))
                                for (var p = 0; p < n.extensions.length; p++)
                                    if (
                                        fs.existsSync(l + "." + n.extensions[p])
                                    ) {
                                        l = l + "." + n.extensions[p];
                                        break;
                                    }
                            fs.readFile(l, function(e, t) {
                                if (e) return c(e);
                                try {
                                    var u, l;
                                    n.htmlScriptRegex &&
                                    o.url.match(n.htmlScriptRegex)
                                        ? ((u = require("./htmlScriptParser")(
                                              i,
                                              t.toString(),
                                              o.url,
                                              n
                                              ...
                                              ? ((u =
                                                ...
                                                s.wrapAwait &&
                                                    ...
                                                    (u +=
                                                        ...
                                                        s.$makeThenable +
                                                        " = " +
                                                        Thenable.resolve.toString() +
                                                        ";"),
                                                (s.mapStartLine = u.split(
                                                    "\n"
                                                ).length),
                                                (u += "\n"))
                                              : (u = ""),
                    ...
                    function requireCover(e, t) {
                        ...
                        var n =
                            ...
                            Object.keys(t)
                                .sort()
                                .reduce(function(e, n) {
                                    return e + n + JSON.stringify(t[n]);
                                }, "");
                        return (
                            this.covers[n] ||
                                (e.indexOf("/") >= 0
                                    ? (this.covers[n] = require(e))
                                    : (this.covers[n] = require(__dirname +
                                          "/covers/" +
                                          e))),
                            this.covers[n](this, t)
                        );
                    }
                    function prepareMappedStackTrace(e, t) {
                        return (
                            e +
                            t
                                .map(function(e) {
                                    ...
                                    if (
                                        t &&
                                        NodentCompiler.prototype.smCache[t]
                                    ) {
                                        var n = NodentCompiler.prototype.smCache[
                                            t
                    ...
                    function setGlobalEnvironment(e) {
                        var t = {};
                        (t[defaultCodeGenOpts.$asyncbind] = {
                            value: $asyncbind,
                            writable: !0,
                            enumerable: !1,
                            configurable: !0
                        }),
                            (t[defaultCodeGenOpts.$asyncspawn] = {
                                value: $asyncspawn,
                                writable: !0,
                                enumerable: !1,
                                configurable: !0
                        ...
                        try {
                            Object.defineProperties(Function.prototype, t);
                        } catch (t) {
                            e.log(
                                "Function prototypes already assigned: ",
                                t.messsage
                            );
                        }
                        defaultCodeGenOpts[defaultCodeGenOpts.$error] in
                            global ||
                            (global[
                                defaultCodeGenOpts[defaultCodeGenOpts.$error]
                            ] = globalErrorHandler),
                            e.augmentObject &&
                                Object.defineProperties(Object.prototype, {
                                    asyncify: {
                                        value: function(e, t, n) {
                                            return asyncify(e)(this, t, n);
                                        },
                                        writable: !0,
                                        configurable: !0
                                    },
                                    isThenable: {
                                        value: function() {
                                            return Thenable.isThenable(this);
                                        },
                                        writable: !0,
                                        configurable: !0
                                    }
                                }),
                            (Object[defaultCodeGenOpts.$makeThenable] =
                                Thenable.resolve);
                    }
                    function initialize(e) {
                        function t(n, r) {
                            if (!r.match(/nodent\/nodent\.js$/)) {
                                if (r.match(/node_modules\/nodent\/.*\.js$/))
                                    return stdJSLoader(n, r);
                                for (var o = 0; o < i.length; o++)
                                    if (
                                        r.slice(0, i[o].path.length) ==
                                        i[o].path
                                    ) {
                                        if (i[o].jsCompiler) {
                                            if (i[o].jsCompiler === t) break;
                                            return i[o].jsCompiler.apply(
                                                this,
                                                arguments
                                            );
                                        }
                                ...
                                var a = parseCompilerOptions(
                                    stripBOM(fs.readFileSync(r, "utf8")),
                                    e.log,
                                    r
                                );
                                return a ? s(n, r, a) : stdJSLoader(n, r);
                            }
                            var u = {
                                path: r.replace(
                            ...
                            u.path &&
                                ((u.version = JSON.parse(
                                    fs.readFileSync(
                                        r.replace(/nodent\.js$/, "package.json")
                                    )
                                ).version),
                                stdJSLoader(n, r),
                                (function(e, t) {
                                    ...
                                    u.version,
                                    NodentCompiler.prototype.version
                                ) < 0 &&
                                    ((u.originalNodentLoader = n.exports),
                                    (n.exports = function() {
                                        var t = require.extensions[".js"],
                                            n = u.originalNodentLoader.apply(
                                                this,
                                                arguments
                                            );
                                        return (
                                            ...
                                            (require.extensions[".js"] = t),
                                            setGlobalEnvironment(e),
                                            n
                                        );
                                    }),
                                    Object.keys(u.originalNodentLoader).forEach(
                                        function(e) {
                                            n.exports[e] =
                                                u.originalNodentLoader[e];
                                        }
                                    ),
                                    i.push(u),
                        ...
                        function n(t) {
                            if (Array.isArray(t)) return t.forEach(n);
                            if (require.extensions[t]) {
                                Object.keys(e).filter(function(t) {
                                    return compiler[t] != e[t];
                                }).length &&
                                    e.log(
                                        "File extension " +
                                            t +
                                            " already configured for async/await compilation."
                                    );
                            }
                            require.extensions[t] = compileNodentedFile(
                                compiler,
                                e.log
                            );
                        }
                        if (e) {
                            for (var r in e)
                                if ("use" !== r && !config.hasOwnProperty(r))
                                    throw new Error(
                                        "NoDent: unknown option: " +
                                            r +
                                            "=" +
                                            JSON.stringify(e[r])
                                    );
                        ...
                        compiler
                            ? compiler.setOptions(e)
                            : (Object.keys(config).forEach(function(t) {
                                  t in e || (e[t] = config[t]);
                              }),
                              (compiler = new NodentCompiler(e))),
                            e.dontMapStackTraces ||
                                (Error.prepareStackTrace = prepareMappedStackTrace),
                            setGlobalEnvironment(e);
                        var i = [];
                        if (!e.dontInstallRequireHook) {
                            if (!stdJSLoader) {
                                stdJSLoader = require.extensions[".js"];
                                var s = compileNodentedFile(compiler, e.log);
                                require.extensions[".js"] = t;
                            }
                            e.extension && n(e.extension);
                        }
                        return (
                            e.use &&
                                (Array.isArray(e.use)
                                    ? (e.log(
                                          "Warning: nodent({use:[...]}) is deprecated. Use nodent.require(module,options)\n" +
                                              new Error().stack.split("\n")[2]
                                      ),
                                      e.use.length &&
                                          e.use.forEach(function(e) {
                                              compiler[e] = compiler.require(e);
                                          }))
                                    : (e.log(
                                          "Warning: nodent({use:{...}}) is deprecated. Use nodent.require(module,options)\n" +
                                              new Error().stack.split("\n")[2]
                                      ),
                                      Object.keys(e.use).forEach(function(t) {
                                          compiler[t] = compiler.require(
                                              t,
                                              e.use[t]
                                          );
                                      }))),
                    ...
                    function runFromCLI() {
                            ...
                            try {
                                ...
                                if (r.fromast) {
                                    if (
                                        ...
                                        !(o = parseCompilerOptions(e, i.log)))
                                    ) {
                                        var a = r.use
                                            ? '"use nodent-' + r.use + '";'
                                            : '"use nodent";';
                                        (o = parseCompilerOptions(a, i.log)),
                                            console.warn(
                                                "/* " +
                                                    t +
                                                    ": No 'use nodent*' directive, assumed " +
                                                    a +
                                                    " */"
                                            );
                                    }
                                } else
                                    (o = parseCompilerOptions(
                                        r.use
                                            ? '"use nodent-' + r.use + '";'
                                            : e,
                                        i.log
                                        ...
                                        r.dest ||
                                            console.warn(
                                                "/* " +
                                                    t +
                                                    ": 'use nodent*' directive missing/ignored, assumed 'use nodent;' */"
                                            )),
                                        (s = i.parse(e, t, o));
                                if (
                                    (r.parseast ||
                                        r.pretty ||
                                        i.asynchronize(s, void 0, o, i.log),
                                    i.prettyPrint(s, o),
                                    r.out || r.pretty || r.dest)
                                ) {
                                    if (r.dest && !n)
                                        throw new Error(
                                            "Can't write unknown file to " +
                                                r.dest
                                        );
                                    var u = "";
                                    r.runtime &&
                                        ((u +=
                                            "Function.prototype.$asyncbind = " +
                                            Function.prototype.$asyncbind.toString() +
                                            ";\n"),
                                        (u +=
                        ...
                        var t,
                            n = require("path"),
                            r = (process.env.NODENT_OPTS &&
                                JSON.parse(process.env.NODENT_OPTS),
                            (function(e) {
                                for (
                                    var t = [], n = e || 2;
                                    ...
                                    if ("--" === process.argv[n].slice(0, 2)) {
                                        var r = process.argv[n]
                                            .slice(2)
                                            .split("=");
                                        t[r[0]] = r[1] || !0;
                                    } else t.push(process.argv[n]);
                                return t;
                            })());
                        initialize.setDefaultCompileOptions({
                            sourcemap: r.sourcemap,
                            wrapAwait: r.wrapAwait,
                            lazyThenables: r.lazyThenables,
                            noRuntime: r.noruntime,
                            es6target: r.es6target,
                            parser: r.noextensions
                                ? {noNodentExtensions: !0}
                                : void 0
                        });
                        var i = initialize({augmentObject: !0});
                        if (
                            !(
                                r.fromast ||
                                r.parseast ||
                        ...
                        if (0 == r.length || "-" === r[0])
                            return (
                                ...
                                })(process.stdin).then(e, globalErrorHandler)
                            );
                        for (var o = 0; o < r.length; o++)
                            (t = n.resolve(r[o])),
                                e(stripBOM(fs.readFileSync(t, "utf8")), r[o]);
                    }
                    var stdJSLoader,
                        fs = require("fs"),
                        ...
                        config = {
                            log: function(e) {
                                console.warn("Nodent: " + e);
                            },
                            augmentObject: !1,
                            extension: ".njs",
                            dontMapStackTraces: !1,
                            asyncStackTrace: !1,
                            babelTree: !1,
                            dontInstallRequireHook: !1
                        },
                        defaultCodeGenOpts = Object.create(
                            NodentCompiler.initialCodeGenOpts,
                            {es7: {value: !0, writable: !0, enumerable: !0}}
                        ),
                        optionSets = {
                            ...
                            generator: Object.create(defaultCodeGenOpts, {
                                ...
                                es7: {value: !1, writable: !0, enumerable: !0}
                            }),
                    ...
                    var useDirective = /^\s*['"]use\s+nodent-?([a-zA-Z0-9]*)?(\s*.*)?['"]\s*;/,
                        runtimes = require("nodent-runtime"),
                        $asyncbind = runtimes.$asyncbind,
                        $asyncspawn = runtimes.$asyncspawn,
                        Thenable = $asyncbind.Thenable,
                        hostOptions = {
                            promises: "Promise",
                            es6target: "()=>0",
                            engine: "(async ()=>0)",
                    ...
                    (NodentCompiler.prototype.Thenable = Thenable),
                        (NodentCompiler.prototype.EagerThenable =
                    ...
                    var compiler;
                    (initialize.setDefaultCompileOptions = function(e, t) {
                        return (
                            e &&
                                Object.keys(e).forEach(function(t) {
                                    if (!(t in defaultCodeGenOpts))
                                        throw new Error(
                                            "NoDent: unknown compiler option: " +
                                                t
                                        );
                                    defaultCodeGenOpts[t] = e[t];
                                }),
                            t &&
                                Object.keys(t).forEach(function(e) {
                                    if (!(e in t))
                                        throw new Error(
                                            "NoDent: unknown configuration option: " +
                                                e
                                        );
                                    config[e] = t[e];
                                }),
                        ...
                        (initialize.setCompileOptions = function(e, t) {
                            return (
                                (optionSet[e] =
                                    optionSet[e] ||
                                    copyObj([defaultCodeGenOpts])),
                                t &&
                                    Object.keys(t).forEach(function(n) {
                                        if (!(n in defaultCodeGenOpts))
                                            throw new Error(
                                                "NoDent: unknown compiler option: " +
                                                    n
                                            );
