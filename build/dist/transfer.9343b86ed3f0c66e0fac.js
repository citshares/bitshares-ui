                ...
                function(e) {
                    ...
                    var B = (function(t) {
                        function a(e) {
                            ...
                            var r = f.a.getState().currentAccount;
                            return (
                                    ...
                                    },
                                    {
                                        ...
                                        value: function() {
                                            ...
                                            var T = this._getAvailableAssets(),
                                                ...
                                                D = T.fee_asset_types,
                                                R = null,
                                                J = this.state.feeAmount.getAmount(
                                                    {real: !0}
                                                );
                                            if (s && s.get("balances") && !t) {
                                                var M = s
                                                    .get("balances")
                                                    .toJS();
                                                if (
                                                    (1 === P.length &&
                                                        (l = A.ChainStore.getAsset(
                                                            P[0]
                                                        )),
                                                    P.length > 0)
                                                ) {
                                            ...
                                            return r.a.createElement(
                                                ...
                                                r.a.createElement(
                                                    ...
                                                    r.a.createElement(
                                                        ...
                                                        {
                                                            className:
                                                                "grid-content small-12 medium-12 large-10 large-offset-1 full-width-content"
                                                        },
